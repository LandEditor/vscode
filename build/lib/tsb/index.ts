...
import { Duplex, Readable, type Writable } from "stream";
...
import { type ITranspiler, SwcTranspiler, TscTranspiler } from "./transpiler";
...
function createNullCompiler(): IncrementalCompiler {
	const result: IncrementalCompiler = () => new EmptyDuplex();
