...
export function create(projectPath: string, existingOptions: Partial<ts.CompilerOptions>, config: {
    verbose?: boolean;
    transpileOnly?: boolean;
    transpileOnlyIncludesDts?: boolean;
    transpileWithSwc?: boolean;
}, onError: (message: string) => void = _defaultOnError): IncrementalCompiler {
    ...
    function createTranspileStream(transpiler: ITranspiler): Readable & Writable {
        return through(function (this: through.ThroughStream & {
            queue(a: any): void;
        }, file: Vinyl) {
            // give the file to the compiler
            if (file.isStream()) {
