...
export module collections {
    ...
    export function insert<T>(collection: {
        [keys: string]: T;
    }, key: string, value: T): void {
        collection[key] = value;
    }
    export function lookupOrInsert<T>(collection: {
        [keys: string]: T;
    ...
    export function forEach<T>(collection: {
        [keys: string]: T;
    }, callback: (entry: {
        key: string;
        value: T;
    ...
    export function contains(collection: {
        [keys: string]: any;
    }, key: string): boolean {
...
export module graph {
    ...
    export class Graph<T> {
        ...
        private _traverse(node: Node<T>, inwards: boolean, seen: {
            [key: string]: boolean;
