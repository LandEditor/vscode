...
exports.minifyTask =
	exports.optimizeTask =
	exports.optimizeLoaderTask =
...
function toConcatStream(
	...
	const treatedSources = sources.map((source) => {
...
function optimizeAMDTask(opts) {
	...
	const fileContentMapper =
		opts.fileContentMapper || ((contents, _path) => contents);
	const sourcemaps = require("gulp-sourcemaps");
	const bundlesStream = es.through(); // this stream will contain the bundled files
	const resourcesStream = es.through(); // this stream will contain the resources
	const bundleInfoStream = es.through(); // this stream will contain bundleInfo.json
	bundle.bundle(entryPoints, loaderConfig, (err, result) => {
		if (err || !result) {
