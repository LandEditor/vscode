...
abstract class BasePolicy implements Policy {
    constructor(protected policyType: PolicyType, protected name: string, readonly category: Category, readonly minimumVersion: string, protected description: NlsString, protected moduleName: string) { }
...
class BooleanPolicy extends BasePolicy {
    ...
    private constructor(name: string, category: Category, minimumVersion: string, description: NlsString, moduleName: string) {
...
class IntPolicy extends BasePolicy {
    ...
    private constructor(name: string, category: Category, minimumVersion: string, description: NlsString, moduleName: string, protected readonly defaultValue: number) {
        super(PolicyType.StringEnum, name, category, minimumVersion, description, moduleName);
    }
    protected renderADMXElements(): string[] {
        return [
...
class StringEnumPolicy extends BasePolicy {
    ...
    private constructor(name: string, category: Category, minimumVersion: string, description: NlsString, moduleName: string, protected enum_: string[], protected enumDescriptions: NlsString[]) {
        super(PolicyType.StringEnum, name, category, minimumVersion, description, moduleName);
    }
    protected renderADMXElements(): string[] {
        return [
