...
exports.buildExtensionMedia =
	exports.webpackExtensions =
	exports.translatePackageJSON =
	exports.scanBuiltinExtensions =
	exports.packageMarketplaceExtensionsStream =
	exports.packageLocalExtensionsStream =
	exports.fromGithub =
	exports.fromMarketplace =
		void 0;
...
function fromLocalWebpack(extensionPath, webpackConfigFileName, disableMangle) {
			...
			const webpackStreams = webpackConfigLocations.flatMap(
				(webpackConfigPath) => {
					const webpackDone = (err, stats) => {
						fancyLog(
							`Bundled extension: ${ansiColors.yellow(
								path.join(
	...
	return result.pipe(
		(0, stats_1.createStatsStream)(path.basename(extensionPath)),
	);
}
...
function packageLocalExtensionsStream(forWeb, disableMangle) {
	const localExtensionsDescriptions = glob
	...
	const marketplaceExtensionsStream = minifyExtensionResources(
		es.merge(
			...marketplaceExtensionsDescriptions.map((extension) => {
				const src = (0, builtInExtensions_1.getExtensionStream)(
					extension,
