...
const windowBootstrapFiles = ["out-build/bootstrap-window.js"];
		...
		optimize.optimizeTask({
			...
			manual: [
				...
				// TODO: @justchen https://github.com/microsoft/vscode/issues/213332 make sure to remove when we use window.open on desktop.
				{
					src: [
						...windowBootstrapFiles,
						"out-build/vs/workbench/contrib/issue/electron-sandbox/issueReporter.js",
					],
					out: "vs/workbench/contrib/issue/electron-sandbox/issueReporter.js",
				},
				{
					src: [
						...windowBootstrapFiles,
