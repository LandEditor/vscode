...
const optimizeVSCodeTask = task.define(
	"optimize-vscode",
	task.series(
		...
		optimize.optimizeTask({
			...
			commonJS: {
				src: "out-build",
				entryPoints: ["out-build/main.js", "out-build/cli.js"],
				platform: "node",
				external: [
					"electron",
					"minimist",
			...
			manual: [
				...
				},
				{
					...
					out: "vs/code/electron-sandbox/issue/issueReporter.js",
				},
				{
					src: [
						...windowBootstrapFiles,
...
gulp.task(
	task.define(
		...
		task.series(core, compileExtensionsBuildTask, () => {
			const pathToMetadata = "./out-vscode/nls.metadata.json";
			const pathToRehWebMetadata =
				"./out-vscode-reh-web/nls.metadata.json";
			...
			return es
				.merge(
					gulp
						.src([pathToMetadata, pathToRehWebMetadata])
						.pipe(
							merge({
...
gulp.task("vscode-translations-import", () => {
