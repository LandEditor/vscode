...
async function processArtifact(
	...
	} else if (prssSettledResult.status === "rejected") {
		// TODO@joaomoreno, let's temporarily ignore these errors
		console.error(prssSettledResult.reason);
	}

	const assetUrl = cdnSettledResult.value;
	const prssUrl =
		prssSettledResult.status === "fulfilled"
			? prssSettledResult.value
			: undefined;
