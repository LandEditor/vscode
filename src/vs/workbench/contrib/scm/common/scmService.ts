...
export class SCMService implements ISCMService {
	...
	get inputValueProviders(): Iterable<ISCMInputValueProvider> {
		return this._inputValueProviders;
	}
	...
	readonly onDidChangeInputValueProviders: Event<void> =
		this._onDidChangeInputValueProviders.event;
	...
	registerSCMInputValueProvider(
		provider: ISCMInputValueProvider
	): IDisposable {
