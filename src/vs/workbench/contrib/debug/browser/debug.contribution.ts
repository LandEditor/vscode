...
} from "vs/workbench/contrib/debug/browser/debugEditorActions";
...
import {
	...
	VariablesView,
	VIEW_MEMORY_ID,
} from "vs/workbench/contrib/debug/browser/variablesView";
import {
	ADD_WATCH_ID,
	ADD_WATCH_LABEL,
...
registerDebugViewMenuItem(
	MenuId.DebugVariablesContext,
	COPY_EVALUATE_PATH_ID,
	nls.localize("copyAsExpression", "Copy as Expression"),
	20,
	CONTEXT_VARIABLE_EVALUATE_NAME_PRESENT,
	undefined,
	"5_cutcopypaste"
...
registerDebugViewMenuItem(
	MenuId.DebugVariablesContext,
	ADD_TO_WATCH_ID,
	nls.localize("addToWatchExpressions", "Add to Watch"),
	100,
	CONTEXT_VARIABLE_EVALUATE_NAME_PRESENT,
	undefined,
	"z_commands"
...
if (isMacintosh) {
	...
	registerTouchBarEntry(
		...
		ContextKeyExpr.and(
			CONTEXT_IN_DEBUG_MODE,
			ContextKeyExpr.notEquals("debugState", "stopped")
		),
		FileAccess.asFileUri(
