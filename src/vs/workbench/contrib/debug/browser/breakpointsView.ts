		...
		IListRenderer<IExceptionBreakpoint, IExceptionBreakpointTemplateData>
{
	...
	renderElement(
		...
		data.breakpoint.title = exceptionBreakpoint.verified
...
registerAction2(
	class extends ViewAction<BreakpointsView> {
		...
		async runInView(
			...
			breakpoint: ExceptionBreakpoint | Breakpoint | FunctionBreakpoint
		): Promise<void> {
			const debugService = accessor.get(IDebugService);
