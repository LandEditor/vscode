	...
	implements IEditorContribution
{
	...
	private static readonly GUTTER_ICON_TRANSPARENT_CLASSNAME =
		"codicon-inline-chat-transparent";
	...
	private _updateCurrentBreakpoints(uri: URI) {
		this._currentBreakpoints = this._debugService
			.getModel()
			.getBreakpoints({ uri });
	}
	...
	private _onEnablementOrModelChanged(): void {
		...
		this._localToDispose.add(
			this._editor.onMouseDown(async (e: IEditorMouseEvent) => {
				...
				const gutterDecorationClassName =
