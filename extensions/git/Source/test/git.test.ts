...
suite("git", () => {
	suite("GitStatusParser", () => {
		...
		test("rename", () => {
			const parser = new GitStatusParser();
			parser.update(
				"R  newfile.txt\0file.txt\0?? file2.txt\0?? file3.txt\0",
			);
			assert.deepStrictEqual(parser.status, [
	...
	suite("parseGitCommit", () => {
		...
		test("multiple parent commits", () => {
			...
			assert.deepStrictEqual(
				parseGitCommits(GIT_OUTPUT_MULTIPLE_PARENTS),
				[
					{
						hash: "52c293a05038d865604c2284aa8698bd087915a1",
						message: "This is a commit message.",
		...
		test("commit with shortstat (no insertions)", () => {
			const GIT_OUTPUT_SINGLE_PARENT =
				"52c293a05038d865604c2284aa8698bd087915a1\n" +
				"John Doe\n" +
				"john.doe@mail.com\n" +
		...
		test("commit with shortstat (no deletions)", () => {
			const GIT_OUTPUT_SINGLE_PARENT =
				"52c293a05038d865604c2284aa8698bd087915a1\n" +
				"John Doe\n" +
				"john.doe@mail.com\n" +
		...
		test("commit list with shortstat", () => {
			const GIT_OUTPUT_SINGLE_PARENT =
				"52c293a05038d865604c2284aa8698bd087915a1\n" +
				"John Doe\n" +
				"john.doe@mail.com\n" +
