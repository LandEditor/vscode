...
class GitIgnoreDecorationProvider implements FileDecorationProvider {
    ...
    constructor(private model: Model) {
        this.onDidChangeFileDecorations = fireEvent(anyEvent<any>(filterEvent(workspace.onDidSaveTextDocument, e => /\.gitignore$|\.git\/info\/exclude$/.test(e.uri.path)), model.onDidOpenRepository, model.onDidCloseRepository));
...
class GitDecorationProvider implements FileDecorationProvider {
    ...
    constructor(private repository: Repository) {
        this.disposables.push(window.registerFileDecorationProvider(this), runAndSubscribeEvent(repository.onDidRunGitStatus, () => this.onDidRunGitStatus()));
    }
...
class GitIncomingChangesFileDecorationProvider implements FileDecorationProvider {
    ...
    constructor(private readonly repository: Repository) {
        this.disposables.push(window.registerFileDecorationProvider(this), runAndSubscribeEvent(repository.historyProvider.onDidChangeCurrentHistoryItemRefs, () => this.onDidChangeCurrentHistoryItemRefs()));
    }
