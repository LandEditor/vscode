...
export class ActionButton {
    ...
    private getPublishBranchActionButton(): SourceControlActionButton | undefined {
        ...
        if (this.state.HEAD?.type === RefType.Tag || !this.state.HEAD?.name || this.state.HEAD?.upstream || this.state.isCommitInProgress || this.state.isMergeInProgress || this.state.isRebaseInProgress || !showActionButton.publish) {
            return undefined;
        }
        // Button icon
