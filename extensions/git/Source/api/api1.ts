...
import { Operation, type OperationResult } from "../operation";
import type { Repository as BaseRepository, Resource } from "../repository";
import { toGitUri } from "../uri";
import { combinedDisposable, filterEvent, mapEvent } from "../util";
import type { GitExtensionImpl } from "./extension";
import {
	type API,
	type APIState,
	type Branch,
...
import type { PickRemoteSourceOptions } from "./git-base";
...
export class ApiRepository implements Repository {
	...
	readonly onDidCommit: Event<void> = mapEvent<OperationResult, void>(
		filterEvent(
			...
			(e) => e.operation === Operation.Commit,
		),
		() => null,
	);
