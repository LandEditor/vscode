...
import {
	...
	type IBranchProtectionProviderRegistry,
} from "./branchProtection";
import { debounce, memoize, throttle } from "./decorators";
import {
	type Repository as BaseRepository,
	type Commit,
	GitError,
	type LogFileOptions,
	type LsTreeElement,
...
import {
	...
	type IPostCommitCommandsProviderRegistry,
} from "./postCommitCommands";
import type { IPushErrorHandlerRegistry } from "./pushError";
import type { IRemoteSourcePublisherRegistry } from "./remotePublisher";
...
import { type IFileWatcher, watch } from "./watch";
...
export class Repository implements Disposable {
	...
	private async handleTagConflict(
		...
		if (!replaceTagsWhenPull) {
			...
			const replaceLocalTagsAlways = l10n.t(
			...
			if (
				choice !== replaceLocalTags &&
				choice !== replaceLocalTagsAlways
			) {
				return false;
			}
