...
export type ApplyOperation = BaseOperation & {
    kind: OperationKind.Apply;
};
export type BlameOperation = BaseOperation & {
    kind: OperationKind.Blame;
};
export type BranchOperation = BaseOperation & {
...
export type CleanOperation = BaseOperation & {
    kind: OperationKind.Clean;
};
export type CommitOperation = BaseOperation & {
    kind: OperationKind.Commit;
};
export type ConfigOperation = BaseOperation & {
...
export type DiffOperation = BaseOperation & {
    kind: OperationKind.Diff;
};
export type FetchOperation = BaseOperation & {
...
export type GetRefsOperation = BaseOperation & {
...
export type IgnoreOperation = BaseOperation & {
    kind: OperationKind.Ignore;
};
export type LogOperation = BaseOperation & {
    kind: OperationKind.Log;
};
export type LogFileOperation = BaseOperation & {
    kind: OperationKind.LogFile;
};
export type MergeOperation = BaseOperation & {
...
export type PullOperation = BaseOperation & {
    kind: OperationKind.Pull;
};
export type PushOperation = BaseOperation & {
    kind: OperationKind.Push;
};
export type RemoteOperation = BaseOperation & {
...
export type ResetOperation = BaseOperation & {
    kind: OperationKind.Reset;
};
export type RebaseOperation = BaseOperation & {
...
export type ShowOperation = BaseOperation & {
    kind: OperationKind.Show;
};
export type StageOperation = BaseOperation & {
    kind: OperationKind.Stage;
};
export type StatusOperation = BaseOperation & {
    kind: OperationKind.Status;
};
export type StashOperation = BaseOperation & {
    kind: OperationKind.Stash;
};
export type SubmoduleUpdateOperation = BaseOperation & {
    kind: OperationKind.SubmoduleUpdate;
};
export type SyncOperation = BaseOperation & {
    kind: OperationKind.Sync;
};
export type TagOperation = BaseOperation & {
