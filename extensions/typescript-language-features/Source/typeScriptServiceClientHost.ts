...
import type { ServiceConfigurationProvider } from "./configuration/configuration";
import {
	DiagnosticLanguage,
	type LanguageDescription,
} from "./configuration/languageDescription";
import type { IExperimentationTelemetryReporter } from "./experimentTelemetryReporter";
import type { DiagnosticKind } from "./languageFeatures/diagnostics";
...
import type { TsServerProcessFactory } from "./tsServer/server";
import type { ITypeScriptVersionProvider } from "./tsServer/versionProvider";
