...
import type { API } from "./tsServer/api";
import type BufferSyncSupport from "./tsServer/bufferSyncSupport";
import type { PluginManager } from "./tsServer/plugins";
import type * as Proto from "./tsServer/protocol/protocol";
import type { ExecutionTarget } from "./tsServer/server";
import type { TypeScriptVersion } from "./tsServer/versionProvider";
