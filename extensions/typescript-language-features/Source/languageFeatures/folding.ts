...
class TypeScriptFoldingProvider implements vscode.FoldingRangeProvider {
    ...
    async provideFoldingRanges(document: vscode.TextDocument, _context: vscode.FoldingContext, token: vscode.CancellationToken): Promise<vscode.FoldingRange[] | undefined> {
