...
class TypeScriptRenameProvider implements vscode.RenameProvider {
    ...
    public async prepareRename(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken): Promise<vscode.Range | undefined> {
    ...
    public async execRename(document: vscode.TextDocument, position: vscode.Position, token: vscode.CancellationToken): Promise<RenameResponse | undefined> {
        const file = this.client.toOpenTsFilePath(document);
    ...
    private async renameFile(fileToRename: string, fullDisplayName: string, newName: string, token: vscode.CancellationToken): Promise<vscode.WorkspaceEdit | undefined> {
