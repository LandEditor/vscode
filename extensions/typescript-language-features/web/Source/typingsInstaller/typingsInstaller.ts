...
class WebTypingsInstallerServer extends ts.server.typingsInstaller.TypingsInstaller {
    ...
    private constructor(override typesRegistry: Map<string, ts.MapLike<string>>, private readonly handleResponse: (response: InstallerResponse) => void, fs: ts.server.ServerHost, private readonly packageManager: PackageManager, globalTypingsCachePath: string) {
