...
suite("Completions", () => {
	...
	test("CSS url() Path completion", async () => {
		...
		const folders = [
			{
				name: "x",
				uri: URI.file(path.resolve(__dirname, "../../test")).toString(
					true,
				),
			},
		];
	...
	test("CSS url() Path Completion - Unquoted url", async () => {
		const testUri = URI.file(
			path.resolve(
				__dirname,
				"../../test/pathCompletionFixtures/about/about.css",
	...
	test("CSS @import Path completion", async () => {
		const testUri = URI.file(
			path.resolve(
				__dirname,
				"../../test/pathCompletionFixtures/about/about.css",
	 ...
	 */
	test("SCSS @import Path completion", async () => {
