...
function exec(command: string, options: cp.ExecOptions): Promise<{
    stdout: string;
    stderr: string;
}> {
    return new Promise<{
...
class FolderDetector {
    ...
    constructor(private _workspaceFolder: vscode.WorkspaceFolder, private _gruntCommand: Promise<string>) {
    }
