			...
			vscode.languages.registerDocumentPasteEditProvider(
				...
				new (class implements vscode.DocumentPasteEditProvider {
					async prepareDocumentPaste(
						...
						dataTransfer.set(
							textPlain,
							new vscode.DataTransferItem("xyz")
						);
						providerAResolve();
					}
				})(),
			...
			vscode.languages.registerDocumentPasteEditProvider(
				...
				new (class implements vscode.DocumentPasteEditProvider {
					async prepareDocumentPaste(
						...
						throw new Error(
							"Expected testing error from bad provider"
						);
					}
				})(),
				{ id: "test", copyMimeTypes: [textPlain] }
