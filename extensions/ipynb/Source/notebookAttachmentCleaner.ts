...
export class AttachmentCleaner implements vscode.CodeActionProvider {
    private _attachmentCache: Map<string /** uri */, Map<string /** cell fragment*/, Map<string /** attachment filename */, IAttachmentData>>> = new Map();
     ...
     */
    private saveAttachmentToCache(notebookUri: string, cellFragment: string, currFilename: string, metadata: {
        [key: string]: any;
    }): void {
     ...
     * @returns
     */
    private getMetadataAttachment(metadata: {
        [key: string]: any;
    }, currFilename: string): {
        [key: string]: any;
    } {
     ...
     */
    private saveAllAttachmentsToCache(metadata: {
        [key: string]: unknown;
    }, notebookUri: string, cellFragment: string): void {
