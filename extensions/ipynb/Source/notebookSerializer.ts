...
import {
	createJupyterCellFromNotebookCell,
	pruneCell,
...
export class NotebookSerializer implements vscode.NotebookSerializer {
	...
	public serializeNotebookToString(data: vscode.NotebookData): string {
		...
		const indentAmount =
			data.metadata &&
			"indentAmount" in data.metadata &&
			typeof data.metadata.indentAmount === "string"
...
export function getNotebookMetadata(
	...
	notebookContent.nbformat =
		notebookContent.nbformat || defaultNotebookFormat.major;
	notebookContent.nbformat_minor =
		notebookContent.nbformat_minor ?? defaultNotebookFormat.minor;
