...
export function getSnippetLabel(counter: {
...
export function createInsertUriListEdit(document: ITextDocument, ranges: readonly vscode.Range[], urlList: UriList, options?: UriListSnippetOptions): {
...
export function createUriListSnippet(document: vscode.Uri, uris: ReadonlyArray<{
    readonly uri: vscode.Uri;
    readonly str?: string;
}>, options?: UriListSnippetOptions): UriSnippet | undefined {
    if (!uris.length) {
        return;
    }
