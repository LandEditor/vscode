...
class ResourcePasteOrDropProvider implements vscode.DocumentPasteEditProvider, vscode.DocumentDropEditProvider {
    ...
    public async provideDocumentPasteEdits(document: vscode.TextDocument, ranges: readonly vscode.Range[], dataTransfer: vscode.DataTransfer, context: vscode.DocumentPasteEditContext, token: vscode.CancellationToken): Promise<vscode.DocumentPasteEdit[] | undefined> {
    ...
    private async _createEdit(document: vscode.TextDocument, ranges: readonly vscode.Range[], dataTransfer: vscode.DataTransfer, settings: {
        insert: InsertMarkdownLink;
        copyIntoWorkspace: CopyFilesSettings;
    }, context: vscode.DocumentPasteEditContext | undefined, token: vscode.CancellationToken): Promise<DropOrPasteEdit | undefined> {
    ...
    private async _createEditFromUriListData(document: vscode.TextDocument, ranges: readonly vscode.Range[], dataTransfer: vscode.DataTransfer, context: vscode.DocumentPasteEditContext | undefined, token: vscode.CancellationToken): Promise<DropOrPasteEdit | undefined> {
     ...
     */
    private async _createEditForMediaFiles(document: vscode.TextDocument, dataTransfer: vscode.DataTransfer, copyIntoWorkspace: CopyFilesSettings, token: vscode.CancellationToken): Promise<DropOrPasteEdit | undefined> {
