...
export async function shouldInsertMarkdownLinkByDefault(parser: IMdParser, document: ITextDocument, pasteUrlSetting: InsertMarkdownLink, ranges: readonly vscode.Range[], token: vscode.CancellationToken): Promise<boolean> {
...
async function shouldSmartPasteForSelection(parser: IMdParser, document: ITextDocument, selectedRange: vscode.Range, token: vscode.CancellationToken): Promise<boolean> {
