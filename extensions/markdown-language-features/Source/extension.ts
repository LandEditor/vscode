...
import { type MdLanguageClient, startClient } from "./client/client";
import { activateShared } from "./extension.shared";
import { VsCodeOutputLogger } from "./logging";
import { type IMdParser, MarkdownItEngine } from "./markdownEngine";
...
function startServer(
	...
	const serverMain = `./server/${
		clientMain.indexOf("/dist/") !== -1 ? "dist" : "out"
	}/node/workerMain`;
