...
suite("Tests for Emmet: Reflect CSS Value command", () => {
	...
	test("Reflect Css Value in css file", (): any =>
		withRandomFileEditor(cssContents, ".css", (editor, doc) => {
	...
	test("Reflect Css Value in css file, selecting entire property", (): any =>
		withRandomFileEditor(cssContents, ".css", (editor, doc) => {
	...
	test("Reflect Css Value in html file", (): any =>
		withRandomFileEditor(htmlContents, ".html", (editor, doc) => {
	...
	test("Reflect Css Value in html file, selecting entire property", (): any =>
		withRandomFileEditor(htmlContents, ".html", (editor, doc) => {
