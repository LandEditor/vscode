...
`;
	...
	test("Emmet Next/Prev Edit point in html file", (): any =>
		withRandomFileEditor(htmlContents, ".html", (editor, _) => {
	...
	test("Emmet Select Next/Prev Item in html file", (): any =>
		withRandomFileEditor(htmlContents, ".html", (editor, _) => {
			...
			expectedNextItemPoints
				.reverse()
				.forEach(([line, colstart, colend]) => {
	...
	test("Emmet Select Next/Prev item at boundary", (): any =>
		withRandomFileEditor(htmlContents, ".html", (editor, _) => {
	...
	test("Emmet Next/Prev Item in html template", (): any => {
...
`;
	...
	test("Emmet Select Next/Prev Item in css file", (): any =>
		withRandomFileEditor(cssContents, ".css", (editor, _) => {
	...
	test("Emmet Select Next/Prev Item in scss file with nested rules", (): any =>
		withRandomFileEditor(scssContents, ".scss", (editor, _) => {
			editor.selections = [new Selection(0, 0, 0, 0)];
	...
	test("Emmet Balance Out in html file", (): any =>
		withRandomFileEditor(htmlContents, "html", (editor, _) => {
	...
	test("Emmet Balance In using the same stack as Balance out in html file", (): any =>
		withRandomFileEditor(htmlContents, "html", (editor, _) => {
	...
	test("Emmet Balance In when selection doesnt span entire node or its inner contents", (): any =>
		withRandomFileEditor(htmlContents, "html", (editor, _) => {
	...
	test("Emmet Balance In/Out in html template", (): any => {
		const htmlTemplate = `
