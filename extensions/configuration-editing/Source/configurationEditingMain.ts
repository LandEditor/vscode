...
import { getLocation, JSONPath, Location, parse, visit } from "jsonc-parser";
			...
			provideCompletionItems(document, position, _token) {
				...
				if (
					...
					if (
						...
						!isLocationInsideTopLevelProperty(location, [
							"launch",
							"tasks",
						])
					) {
					...
					return [
						...
						{
							label: "file",
							detail: vscode.l10n.t("The current opened file"),
						},
						{
							label: "cwd",
							detail: vscode.l10n.t(
