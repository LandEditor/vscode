...
/** @type {RunFunction} */
module.exports.run = async (debugSession) => {
		...
		debugSession.evalJs(
			(changes, debugSessionName) => {
				...
				function setMessage(message) {
					const domElem = /** @type {HTMLDivElement | undefined} */ (
						document.querySelector(".titlebar-center .window-title")
					);
					if (!domElem) {
						return;
					}
