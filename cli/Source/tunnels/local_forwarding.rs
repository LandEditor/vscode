...
struct PortForwardingSender {
	...
	///
	/// If PortForwardingSender is ever used in a different context, this
	/// should be refactored, e.g. to use locks or `&mut self` in set_ports`
	///
...
async fn serve_singleton_rpc(
	...
	loop {
		...
		tokio::spawn(async move {
			// we make an rpc for the connection instead of re-using a
