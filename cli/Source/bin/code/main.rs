...
use clap::Parser;
use cli::{
	commands::{CommandContext, args, serve_web, tunnels, update, version},
	constants::get_default_user_agent,
	desktop,
	log,
	state::LauncherPaths,
	util::{
		errors::{AnyError, wrap},
		is_integrated_cli,
...
async fn main() -> Result<(), std::convert::Infallible> {
	...
	// gets a command context with the global logger installer. Usually what most
	// commands want.
	macro_rules! context {
		() => {{
