...
describe("API Integration Tests", function (): void {
	...
	it("`monaco` is not exposed as global", async (): Promise<any> => {
		assert.strictEqual(await page.evaluate("typeof monaco"), "undefined");
	});

	it("Focus and Type", async (): Promise<any> => {
		await page.evaluate(`
		(function () {
			instance.focus();
	...
	it("Type and Undo", async (): Promise<any> => {
		await page.evaluate(`
		(function () {
			instance.focus();
			instance.trigger('keyboard', 'cursorHome');
	...
	it("Multi Cursor", async (): Promise<any> => {
		await page.evaluate(`
		(function () {
			instance.focus();
