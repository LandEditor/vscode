...
import { type IDisposable, dispose } from "../../../common/lifecycle.js";
import * as platform from "../../../common/platform.js";
import {
	type INewScrollDimensions,
	type INewScrollPosition,
	type IScrollDimensions,
...
import type { ScrollbarHost } from "./abstractScrollbar.js";
...
function resolveOptions(
	...
	const result: ScrollableElementResolvedOptions = {
		...
		useShadows:
			typeof opts.useShadows !== "undefined" ? opts.useShadows : true,
		handleMouseWheel:
		...
		listenOnDomNode:
			typeof opts.listenOnDomNode !== "undefined"
		...
		scrollByPage:
			typeof opts.scrollByPage !== "undefined"
				? opts.scrollByPage
				: false,
	};
