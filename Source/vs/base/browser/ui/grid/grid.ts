...
import type { AutoSizing as SplitViewAutoSizing } from "vs/base/browser/ui/splitview/splitview";
...
export type IGridStyles = IGridViewStyles;
export type IGridOptions = IGridViewOptions;
