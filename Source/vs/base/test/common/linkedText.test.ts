...
suite("LinkedText", () => {
	test("parses correctly", () => {
		...
		assert.deepStrictEqual(
			parseLinkedText("Some message with [link text](http://link.href).")
				.nodes,
			[
				"Some message with ",
		...
		assert.deepStrictEqual(
			parseLinkedText("Some message with [link text](random stuff).")
				.nodes,
		...
		assert.deepStrictEqual(
			parseLinkedText("Some message with [a command](command:foobar).")
				.nodes,
			[
				"Some message with ",
