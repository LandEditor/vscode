	...
	suite("base64", () => {
		...
		*/
		...
		const testCases: [Uint8Array, string][] = [
			...
			[
				new Uint8Array([
					203, 182, 165, 51, 208, 27, 123, 223, 112, 198, 127, 147,
				]),
				"y7alM9Abe99wxn+T",
			],
			[
				new Uint8Array([
					154, 93, 222, 41, 117, 234, 250, 85, 95, 144, 16, 94, 18,
				]),
				"ml3eKXXq+lVfkBBeEg==",
			],
			[
				new Uint8Array([
					246, 186, 88, 105, 192, 57, 25, 168, 183, 164, 103, 162,
					243, 56,
				]),
				"9rpYacA5Gai3pGei8zg=",
			],
			[
				new Uint8Array([
					149, 240, 155, 96, 30, 55, 162, 172, 191, 187, 33, 124, 169,
					183, 254,
				]),
				"lfCbYB43oqy/uyF8qbf+",
			],
