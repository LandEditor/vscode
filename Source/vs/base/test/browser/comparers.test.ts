...
suite("Comparers", () => {
	...
	test("compareFileExtensions", () => {
		...
		assert.notDeepStrictEqual(
			...
			["email", "Email", "émail", "Émail"].sort((a, b) =>
				a.localeCompare(b)
			),
			"the same base characters with different case or accents do not sort in locale order"
		);
	...
	test("compareFileExtensionsDefault", () => {
		...
		assert(
			compareFileExtensionsDefault("aggregate.go", "aggregate_repo.go") >
				0,
	...
	test("compareFileExtensionsUpper", () => {
		...
		assert(
			compareFileExtensionsUpper("a.MD", "a.md") ===
				compareLocale("MD", "md"),
			"case differences in extensions sort by locale"
		);
		assert(
	...
	test("compareFileExtensionsLower", () => {
		...
		assert(
			compareFileExtensionsLower("a.MD", "a.md") ===
				compareLocale("MD", "md"),
			"case differences in extensions sort by locale"
		);
	...
	test("compareFileExtensionsUnicode", () => {
		...
		assert(
			compareFileExtensionsUnicode("aggregate.go", "aggregate_repo.go") <
				0,
