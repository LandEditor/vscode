...
import type { LanguageId } from "vs/editor/common/encodedTokenAttributes";
import type { IModelChangedEvent } from "vs/editor/common/model/mirrorTextModel";
import type { IWorkerContext } from "vs/editor/common/services/editorSimpleWorker";
import {
	type ICreateGrammarResult,
	TMGrammarFactory,
} from "vs/workbench/services/textMate/common/TMGrammarFactory";
import type {
	IValidEmbeddedLanguagesMap,
	IValidGrammarDefinition,
	IValidTokenTypeMap,
} from "vs/workbench/services/textMate/common/TMScopeRegistry";
