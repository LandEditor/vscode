...
import type {
	ICommandActionTitle,
	ILocalizedString,
} from "vs/platform/action/common/action";
...
import type { IProgressIndicator } from "vs/platform/progress/common/progress";
...
import type { ViewPaneContainer } from "vs/workbench/browser/parts/views/viewPaneContainer";
...
export class ViewsService extends Disposable implements IViewsService {
	...
	private onDidChangeContainerLocation(
		...
		if (
			...
			this.viewDescriptorService.getViewContainersByLocation(to)
				.length === 1
		) {
