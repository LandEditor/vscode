...
import { type DisposableStore, toDisposable } from "vs/base/common/lifecycle";
import { ProxyChannel, getDelayedChannel } from "vs/base/parts/ipc/common/ipc";
import type { IFileChange } from "vs/platform/files/common/files";
import {
	AbstractUniversalWatcherClient,
	type ILogMessage,
	type IRecursiveWatcher,
} from "vs/platform/files/common/watcher";
import type { IUtilityProcessWorkerWorkbenchService } from "vs/workbench/services/utilityProcess/electron-sandbox/utilityProcessWorkerWorkbenchService";
