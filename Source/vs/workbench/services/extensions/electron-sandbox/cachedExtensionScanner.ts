...
export class CachedExtensionScanner {
	...
	public async scanSingleExtension(
		...
		return scannedExtension
			? toExtensionDescriptionFromScannedExtension(
					scannedExtension,
					false,
				)
			: null;
	...
	private async _scanInstalledExtensions(): Promise<IExtensionDescription[]> {
		try {
			...
			const userGlobal = scannedUserExtensions.map((e) =>
				toExtensionDescriptionFromScannedExtension(e, false),
			);
			const userWorkspace = workspaceExtensions.map((e) =>
