...
import type { IExtensionHostManager } from "vs/workbench/services/extensions/common/extensionHostManagers";
import type { IResolveAuthorityErrorResult } from "vs/workbench/services/extensions/common/extensionHostProxy";
...
import type { ExtensionsProposedApi } from "vs/workbench/services/extensions/common/extensionsProposedApi";
import {
	...
	implements IExtensionService
{
	...
	private _createExtensionHostManager(
		...
		processManager.onDidChangeResponsiveState((responsiveState) => {
			this._logService.info(
				`Extension host (${processManager.friendyName}) is ${
