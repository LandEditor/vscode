...
import type { ITextSearchResult } from "vs/workbench/services/search/common/search";
import type { TextSearchPreviewOptions } from "vs/workbench/services/search/common/searchExtTypes";
