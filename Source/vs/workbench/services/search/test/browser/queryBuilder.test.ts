		...
		assertEqualTextQueries(
			...
			]),
			{
				...
				folderQueries: [
					{
						folder: ROOT_1_URI,
						excludePattern: patternsToIExpression("foo/**/*.js"),
					},
					{
						folder: ROOT_2_URI,
		...
		assertEqualTextQueries(
			...
			}),
			{
				...
				folderQueries: [
					{
						folder: ROOT_1_URI,
						excludePattern: patternsToIExpression(
							"bar/**/*.ts",
							"bar/**/*.ts/**"
						),
					},
...
export function fixPath(...slashPathParts: string[]): string {
	if (
		isWindows &&
		slashPathParts.length &&
		!slashPathParts[0].match(/^c:/i)
	) {
