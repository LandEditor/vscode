...
flakySuite("FileSearchEngine", () => {
	...
	test("Files: maxResults", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			maxResults: 1,
	...
	test("Files: maxResults without Ripgrep", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			maxResults: 1,
	...
	test("Files: not exists", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test("Files: exists without Ripgrep", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			includePattern: { "**/file.txt": true },
	...
	test("Files: not exists without Ripgrep", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			includePattern: { "**/nofile.txt": true },
	...
	test("Files: examples/com*", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test("Files: examples (fuzzy)", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "xl",
	...
	test("Files: multiroot", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
	...
	test("Files: multiroot with includePattern and maxResults", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: MULTIROOT_QUERIES,
			maxResults: 1,
	...
	test("Files: multiroot with includePattern and exists", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: MULTIROOT_QUERIES,
			exists: true,
	...
	test("Files: NPE (CamelCase)", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "NullPE",
	...
	test("Files: *.* without derived", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "site.*",
	...
	test("Files: *.* exclude folder without wildcard", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "*.*",
	...
	test("Files: exclude folder without wildcard #36438", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
	...
	test("Files: include folder without wildcard #36438", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY_36438,
	...
	test("Files: *.* exclude folder with leading wildcard", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "*.*",
	...
	test("Files: *.* exclude folder with trailing wildcard", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "*.*",
	...
	test("Files: *.* exclude with unicode", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "*.*",
	...
	test("Files: *.* include with unicode", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "*.*",
	...
	test("Files: multiroot with exclude", (done: () => void) => {
	...
	test("Files: Unicode and Spaces", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			filePattern: "汉语",
	...
	test("Files: no results", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test("Files: relative path matched once", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
	...
	test("Files: Include pattern, single files", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: ROOT_FOLDER_QUERY,
			includePattern: {
	...
	test("Files: extraFiles only", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [],
			extraFileResources: [
	...
	test("Files: extraFiles only (with include)", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [],
			extraFileResources: [
	...
	test("Files: extraFiles only (with exclude)", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [],
			extraFileResources: [
	...
	test("Files: no dupes in nested folders", (done: () => void) => {
		const engine = new FileSearchEngine({
			type: QueryType.File,
			folderQueries: [
				{ folder: EXAMPLES_FIXTURES },
