...
import type { HTMLFileSystemProvider } from "vs/platform/files/browser/htmlFileSystemProvider";
...
export class LocalFileSearchWorkerClient
	extends Disposable
	implements ISearchResultProvider, ILocalFileSearchSimpleWorkerHost
{
