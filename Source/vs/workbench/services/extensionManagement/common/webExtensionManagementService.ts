	...
	implements IProfileAwareExtensionManagementService
{
	...
	override async canInstall(
		...
		return new MarkdownString(
			`${localize("not web tooltip", "The '{0}' extension is not available in {1}.", gallery.displayName || gallery.identifier.id, productName)} [${localize("learn why", "Learn Why")}](https://aka.ms/vscode-web-extensions-guide)`,
		);
	}
