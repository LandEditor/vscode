	...
	class extends Action2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title.start", "Start Extension Bisect"),
	...
	class extends Action2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title.isBad", "Continue Extension Bisect"),
	...
	class extends Action2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title.stop", "Stop Extension Bisect"),
