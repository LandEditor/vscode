...
import type * as platform from "vs/base/common/platform";
import { URI, type UriComponents, type UriDto } from "vs/base/common/uri";
...
import type { IExtensionHostExitInfo } from "vs/workbench/services/remote/common/remoteAgentService";
