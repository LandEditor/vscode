...
export interface MainThreadChatAgentsShape2 extends IDisposable {
	...
	$handleProgressChunk(
		requestId: string,
		chunk: IChatResponseProgressDto,
...
export interface MainThreadInlineChatShape extends IDisposable {
	$registerInteractiveEditorProvider(
		handle: number,
		label: string,
		debugName: string,
...
export type IInlineChatResponseDto = Dto<
	| IInlineChatEditResponse
	| (Omit<IInlineChatBulkEditResponse, "edits"> & {
...
export interface MainThreadSCMShape extends IDisposable {
	...
	$setInputBoxActionButton(
		sourceControlHandle: number,
		actionButton?: SCMInputActionButtonDto | null
	): void;
...
export const MainContext = {
	...
	MainThreadChatAgents: createProxyIdentifier<MainThreadChatAgentsShape>(
...
export const ExtHostContext = {
	...
	ExtHosLabelService: createProxyIdentifier<ExtHostLabelServiceShape>(
		"ExtHostLabelService"
	),
	ExtHostNotebook:
	...
	ExtHostChatAgents:
		createProxyIdentifier<ExtHostChatAgentsShape>("ExtHostChatAgents"),
	ExtHostChatAgents2:
