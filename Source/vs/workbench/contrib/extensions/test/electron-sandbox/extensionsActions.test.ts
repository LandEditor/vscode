...
suite("ExtensionsActions", () => {
	...
	test("Test ManageExtensionAction when there is no extension", () => {
		const testObject: ExtensionsActions.ManageExtensionAction =
			disposables.add(
				instantiationService.createInstance(
...
suite("ReloadAction", () => {
	...
	test("Test ReloadAction when there is no extension", () => {
		const testObject: ExtensionsActions.ReloadAction = disposables.add(
			instantiationService.createInstance(ExtensionsActions.ReloadAction)
		);
		disposables.add(
			instantiationService.createInstance(ExtensionContainers, [
				testObject,
