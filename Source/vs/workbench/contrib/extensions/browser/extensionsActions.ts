...
export class ToggleAutoUpdateForExtensionAction extends ExtensionAction {
	...
	constructor(
		...
		super(
			...
			ToggleAutoUpdateForExtensionAction.LABEL,
...
async function getContextMenuActionsGroups(
	...
	return instantiationService.invokeFunction(async (accessor) => {
		...
		if (extension) {
			...
			cksOverlay.push([
				"installedExtensionIsOptedTpPreRelease",
				!!extension.local?.preRelease,
			]);
			cksOverlay.push([
...
export class SwitchToPreReleaseVersionAction extends ExtensionAction {
	...
	static readonly TITLE = {
		...
		original: "Switch to  Pre-Release Version",
	};
	...
	constructor(
		...
		super(
			SwitchToPreReleaseVersionAction.ID,
...
export class SwitchToReleasedVersionAction extends ExtensionAction {
	...
	static readonly TITLE = {
		...
		original: "Switch to Release Version",
	};
	...
	constructor(
		...
		super(
			SwitchToReleasedVersionAction.ID,
		...
		if (pick) {
			...
			try {
				if (pick.latest) {
					...
					await this.extensionsWorkbenchService.installVersion(
						this.extension!,
						pick.id,
						{ installPreReleaseVersion: pick.isPreReleaseVersion }
					);
...
export class ReloadAction extends ExtensionAction {
	...
	update(): void {
		...
		this.label =
			reloadTooltip !== undefined
				? localize("reload required", "Reload Required")
				: "";
...
function getQuickPickEntries(
	...
	if (showCurrentTheme) {
		picks.push(<IQuickPickSeparator>{
			type: "separator",
			label: localize("current", "current"),
		});
		picks.push(<IQuickPickItem>{
...
export class ClearLanguageAction extends ExtensionAction {
	...
	static readonly TITLE = {
		...
		original: "Clear Display Language",
	};
