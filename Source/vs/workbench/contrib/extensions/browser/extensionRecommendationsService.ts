...
import { type CancelablePromise, timeout } from "vs/base/common/async";
...
import type { ExtensionRecommendation } from "vs/workbench/contrib/extensions/browser/extensionRecommendations";
