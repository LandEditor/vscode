...
} from "vs/workbench/contrib/extensions/browser/extensionsViewlet";
import {
...
} from "vs/workbench/contrib/extensions/browser/extensionsQuickAccess";
...
import {
	...
	CutAction,
	PasteAction,
} from "vs/editor/contrib/clipboard/browser/clipboard";
...
Registry.as<IViewContainersRegistry>(
...
).registerViewContainer(
	{
		id: VIEWLET_ID,
		title: {
			value: localize("extensions", "Extensions"),
			original: "Extensions",
		},
		...
		try {
			if (typeof arg === "string") {
				...
				if (extension) {
					...
					if (version) {
						await extensionsWorkbenchService.installVersion(
							extension,
							version,
							installOptions
						);
	...
	implements IWorkbenchContribution
{
	...
	private registerGlobalActions(): void {
		...
		this.registerExtensionAction({
			...
			title: {
				value: localize("focusExtensions", "Focus on Extensions View"),
				original: "Focus on Extensions View",
			},
			category: ExtensionsLocalizedLabel,
			f1: true,
			run: async (accessor: ServicesAccessor) => {
				await accessor
					.get(IPaneCompositePartService)
					.openPaneComposite(
						VIEWLET_ID,
						ViewContainerLocation.Sidebar,
						true
		...
		this.registerExtensionAction({
			...
			title: {
				value: localize("installExtensions", "Install Extensions"),
				original: "Install Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: {
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Check for Extension Updates",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			run: (accessor: ServicesAccessor) =>
				accessor
					...
					.updateValue(AutoUpdateConfigurationKey, true),
		});
		...
		this.registerExtensionAction({
			...
			run: (accessor: ServicesAccessor) =>
				accessor
					.get(IConfigurationService)
					.updateValue(AutoUpdateConfigurationKey, false),
		});

		this.registerExtensionAction({
			id: "workbench.extensions.action.updateAllExtensions",
			title: {
				value: localize("updateAll", "Update All Extensions"),
				original: "Update All Extensions",
			},
			category: ExtensionsLocalizedLabel,
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Disable Auto Update for All Extensions",
			},
			category: ExtensionsLocalizedLabel,
			f1: true,
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Enable Auto Update for All Extensions",
			},
			category: ExtensionsLocalizedLabel,
			f1: true,
			precondition: CONTEXT_HAS_GALLERY,
		...
		this.registerExtensionAction({
			...
			title: {
				value: localize("enableAll", "Enable All Extensions"),
				original: "Enable All Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Enable All Extensions for this Workspace",
			},
			category: ExtensionsLocalizedLabel,
			menu: {
				id: MenuId.CommandPalette,
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Disable All Installed Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Disable All Installed Extensions for this Workspace",
			},
			category: ExtensionsLocalizedLabel,
			menu: {
				id: MenuId.CommandPalette,
		...
		this.registerExtensionAction({
			...
			title: {
				value: localize("InstallFromVSIX", "Install from VSIX..."),
				original: "Install from VSIX...",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			run: async (accessor: ServicesAccessor, resources: URI[] | URI) => {
				...
				const extensions = Array.isArray(resources)
					? resources
					: [resources];
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Install Extension from Location...",
			},
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Featured Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Popular Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Recommended Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Recently Published Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Built-in Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				value: localize("extensionUpdates", "Show Extension Updates"),
				original: "Show Extension Updates",
			},
			category: ExtensionsLocalizedLabel,
			precondition: CONTEXT_HAS_GALLERY,
			f1: true,
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Extensions Unsupported By Workspace",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Enabled Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Disabled Extensions",
			},
			category: ExtensionsLocalizedLabel,
			menu: [
				{
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Clear Extensions Search Results",
			},
			category: ExtensionsLocalizedLabel,
		...
		this.registerExtensionAction({
			...
			title: {
				value: localize("refreshExtension", "Refresh"),
				original: "Refresh",
			},
			category: ExtensionsLocalizedLabel,
			icon: refreshIcon,
	...
	private registerContextMenuActions(): void {
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Show Pre-Release Version",
			},
			menu: {
				id: MenuId.ExtensionContext,
		...
		this.registerExtensionAction({
			...
			title: {
				value: ToggleAutoUpdateForExtensionAction.LABEL,
		...
		this.registerExtensionAction({
			...
			menu: {
				...
				order: 2,
				when: ContextKeyExpr.and(
					ContextKeyExpr.not("installedExtensionIsPreReleaseVersion"),
					ContextKeyExpr.not("installedExtensionIsOptedTpPreRelease"),
					ContextKeyExpr.has("extensionHasPreReleaseVersion"),
					ContextKeyExpr.not("inExtensionEditor"),
					ContextKeyExpr.equals("extensionStatus", "installed"),
					ContextKeyExpr.not("isBuiltinExtension")
		...
		this.registerExtensionAction({
			...
			menu: {
				...
				order: 3,
				when: ContextKeyExpr.and(
					ContextKeyExpr.has("installedExtensionIsPreReleaseVersion"),
					ContextKeyExpr.has("extensionHasPreReleaseVersion"),
					ContextKeyExpr.has("extensionHasReleaseVersion"),
					ContextKeyExpr.not("inExtensionEditor"),
					ContextKeyExpr.equals("extensionStatus", "installed"),
		...
		this.registerExtensionAction({
			...
			title: {
				...
				original: "Extension Keyboard Shortcuts",
			},
			menu: {
				id: MenuId.ExtensionContext,
				group: "2_configure",
