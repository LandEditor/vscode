...
import {
	isVirtualResource,
	isVirtualWorkspace,
} from "vs/platform/workspace/common/virtualWorkspace";
import {
...
import type { WorkspaceTrustEditorInput } from "vs/workbench/services/workspaces/browser/workspaceTrustEditorInput";
...
export class WorkspaceTrustEditor extends EditorPane {
	...
	private async render() {
		...
		this.rootElement.setAttribute(
			"aria-label",
			`${localize("root element label", "Manage Workspace Trust")}:  ${
