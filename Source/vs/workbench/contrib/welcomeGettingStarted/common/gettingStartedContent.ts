...
const CopilotSignedOutButton = Button(
	localize("setupCopilotButton.signIn", "Set Up Copilot for Free"),
	`command:workbench.action.chat.triggerSetup`,
);
const CopilotSignedInButton = Button(
	localize("setupCopilotButton.setup", "Set Up Copilot for Free"),
	`command:workbench.action.chat.triggerSetup`,
);
		...
		content: {
			...
			steps: [
				createCopilotSetupStep(
					...
					"config.chat.experimental.offerSetup && chatSetupSignedOut",
					true,
				),
				createCopilotSetupStep(
					"CopilotSetupComplete",
					CopilotCompleteButton,
					"config.chat.experimental.offerSetup && chatSetupInstalled && (chatSetupEntitled || chatSetupLimited)",
					false,
				),
				createCopilotSetupStep(
					"CopilotSetupSignedIn",
					CopilotSignedInButton,
					"config.chat.experimental.offerSetup && !chatSetupSignedOut && (!chatSetupInstalled || chatSetupCanSignUp)",
					true,
				),
				{
					id: "pickColorTheme",
