...
const intermediateIcon = registerIcon(
			...
			steps: [
				{
					...
					description: localize(
						...
						Button(
							...
							"command:toSide:workbench.action.showInteractivePlayground"
						)
					),
					media: {
						type: "svg",
						altText: "Editor Playground.",
						path: "interactivePlayground.svg",
					},
				},
				{
					id: "terminal",
					...
					description: localize(
						...
						Button(
							localize("showTerminal", "Show Terminal Panel"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("tweakSettings", "Tweak my Settings"),
				...
				},
				{
					...
					description: localize(
						...
						Button(
							localize("tryProfiles", "Try Profiles"),
							"command:workbench.profiles.actions.createProfile"
						)
					),
					media: {
						type: "svg",
						altText: "VS Code Profiles",
						path: "profiles.svg",
					},
				},
				{
			...
			steps: [
				{
					...
					description: localize(
						...
						Button(
							localize("splitEditor", "Split Editor"),
							"command:workbench.action.splitEditor"
						)
					),
					media: {
						type: "svg",
						altText: "Multiple editors in split view.",
						path: "sideBySide.svg",
					},
				},
				{
