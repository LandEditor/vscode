	...
	class extends ViewAction<IMarkersView> {
		constructor() {
			super({
				...
				toggled: {
					condition:
						MarkersContextKeys.ShowActiveFileFilterContextKey,
	...
	class extends ViewAction<IMarkersView> {
		constructor() {
			super({
				...
				toggled: {
					condition:
						MarkersContextKeys.ShowExcludedFilesFilterContextKey,
	...
	class extends Action2 {
		constructor() {
			super({
				...
				title: {
					value: Messages.MARKERS_PANEL_SHOW_LABEL,
	...
	class extends ViewAction<IMarkersView> {
		constructor() {
			...
			super({
				...
				title: {
					value: localize("copyMarker", "Copy"),
					original: "Copy",
				},
				menu: {
	...
	class extends ViewAction<IMarkersView> {
		constructor() {
			super({
				...
				title: {
					value: localize("copyMessage", "Copy Message"),
