	...
	class PeekCallHierarchyAction extends EditorAction2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title", "Peek Call Hierarchy"),
	...
	class extends EditorAction2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title.incoming", "Show Incoming Calls"),
	...
	class extends EditorAction2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title.outgoing", "Show Outgoing Calls"),
	...
	class extends EditorAction2 {
		constructor() {
			super({
				...
				title: {
					value: localize("title.refocus", "Refocus Call Hierarchy"),
