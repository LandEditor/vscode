...
import { basename, extname, isAbsolute } from "vs/base/common/path";
...
import {
	BrowserFileUpload,
	FileDownload,
} from "vs/workbench/contrib/files/browser/fileImportExport";
...
export function incrementFileName(
	...
	if (!isFolder && lastIndexOfDot >= 0) {
		return `${name.substr(0, lastIndexOfDot)}.1${name.substr(
			lastIndexOfDot,
		)}`;
	}
...
export class GlobalCompareResourcesAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: GlobalCompareResourcesAction.LABEL,
				original: "Compare Active File With...",
			},
			f1: true,
...
export class FocusFilesExplorer extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: FocusFilesExplorer.LABEL,
				original: "Focus on Files Explorer",
			},
			f1: true,
			category: Categories.File,
		});
...
export class ShowActiveFileInExplorer extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: ShowActiveFileInExplorer.LABEL,
				original: "Reveal Active File in Explorer View",
			},
			f1: true,
			category: Categories.File,
		});
...
export class OpenActiveFileInEmptyWorkspace extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: OpenActiveFileInEmptyWorkspace.LABEL,
				original: "Open Active File in New Empty Workspace",
			},
			f1: true,
			category: Categories.File,
			keybinding: {
...
export class CompareNewUntitledTextFilesAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: CompareNewUntitledTextFilesAction.LABEL,
				original: "Compare New Untitled Text Files",
			},
			f1: true,
			category: Categories.File,
		});
...
export class CompareWithClipboardAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: CompareWithClipboardAction.LABEL,
				original: "Compare Active File with Clipboard",
			},
			f1: true,
			category: Categories.File,
			keybinding: {
		...
		const message =
			toPaste.length > 1
				...
				: nls.localize(
						...
						basename(toPaste[0].fsPath),
				  );
		const detail =
			toPaste.length > 1 ? getFileNamesMessage(toPaste) : undefined;
...
export class SetActiveEditorReadonlyInSession extends BaseSetActiveEditorReadonlyInSession {
	...
	constructor() {
		super(
			...
			{
				value: SetActiveEditorReadonlyInSession.LABEL,
				original: "Set Active Editor Readonly in Session",
			},
			true,
		);
	}
...
export class SetActiveEditorWriteableInSession extends BaseSetActiveEditorReadonlyInSession {
	...
	constructor() {
		super(
			...
			{
				value: SetActiveEditorWriteableInSession.LABEL,
...
export class ToggleActiveEditorReadonlyInSession extends BaseSetActiveEditorReadonlyInSession {
	...
	constructor() {
		super(
			...
			{
				value: ToggleActiveEditorReadonlyInSession.LABEL,
				original: "Toggle Active Editor Readonly in Session",
			},
			"toggle",
		);
	}
...
export class ResetActiveEditorReadonlyInSession extends BaseSetActiveEditorReadonlyInSession {
	...
	constructor() {
		super(
			...
			{
				value: ResetActiveEditorReadonlyInSession.LABEL,
				original: "Reset Active Editor Readonly in Session",
			},
			"reset",
		);
	}
