...
appendToCommandPalette({
	id: COPY_PATH_COMMAND_ID,
	title: {
		value: nls.localize("copyPathOfActive", "Copy Path of Active File"),
...
appendToCommandPalette({
	...
	title: {
		value: SAVE_FILE_WITHOUT_FORMATTING_LABEL,
		original: "Save without Formatting",
	},
	category: Categories.File,
});
...
appendToCommandPalette({
	...
	title: {
		value: nls.localize("saveAllInGroup", "Save All in Group"),
...
appendToCommandPalette({
	...
	title: {
		value: nls.localize("saveFiles", "Save All Files"),
...
appendToCommandPalette({
	...
	title: {
		value: nls.localize("revert", "Revert File"),
