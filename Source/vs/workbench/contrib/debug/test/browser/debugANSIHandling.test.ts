...
import {
	TestColorTheme,
	TestThemeService,
} from "vs/platform/theme/test/common/testThemeService";
import {
	appendStylizedStringToContainer,
	calcANSI8bitColor,
	handleANSIOutput,
} from "vs/workbench/contrib/debug/browser/debugANSIHandling";
	...
	function assertInlineColor(
		...
		if (color !== undefined) {
			...
			if (colorType === "background") {
				...
				assert(
					(styleBefore === element.style.backgroundColor) ===
						colorShouldMatch,
					message ||
	...
	test("Expected multiple sequence operation", () => {
		...
		assertMultipleSequenceElements(
			...
			[
				...
				(justgreen) => {
					assert.strictEqual(1, justgreen.classList.length);
					assert(
						justgreen.classList.contains("code-rapid-blink") ===
							false,
		...
		assertMultipleSequenceElements(
			...
			[
				...
				(doubleunderline) => {
					assert(
						doubleunderline.classList.contains("code-underline") ===
							false,
		...
		assertMultipleSequenceElements(
			...
			[
				...
				(underlineoff) => {
					assert(
						underlineoff.classList.contains("code-underline") ===
							false,
				...
				(overlineoff) => {
					assert(
						overlineoff.classList.contains("code-underline") ===
							false,
						"Underline class found after overline off code 55m"
					);
					assert(
						overlineoff.classList.contains("code-overline") ===
							false,
				...
				(nothing) => {
					assert(
						nothing.classList.contains("code-strike-through") ===
							false,
		...
		assertMultipleSequenceElements(
			...
			[
				...
				(nothing) => {
					assert(
						nothing.classList.contains("code-double-underline") ===
							false,
		...
		assertMultipleSequenceElements(
			...
			[
				...
				(subscript) => {
					assert(
						subscript.classList.contains("code-superscript") ===
							false,
				...
				(superscript) => {
					assert(
						superscript.classList.contains("code-subscript") ===
							false,
