...
import {
	...
	getExpandedBodySize,
} from "vs/workbench/contrib/debug/browser/breakpointsView";
import {
	IBreakpointData,
...
import {
	MockDebugService,
	MockDebugStorage,
} from "vs/workbench/contrib/debug/test/common/mockDebug";
...
suite("Debug - Breakpoints", () => {
	...
	test("decorations", () => {
		...
		}).appendCodeblock(languageId, "Expression condition: x > 5");
