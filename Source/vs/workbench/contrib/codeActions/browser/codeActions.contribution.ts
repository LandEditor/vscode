...
} from "vs/workbench/contrib/codeActions/common/codeActionsExtensionPoint";
import {
	DocumentationExtensionPoint,
	documentationExtensionPointDescriptor,
} from "vs/workbench/contrib/codeActions/common/documentationExtensionPoint";
import { ExtensionsRegistry } from "vs/workbench/services/extensions/common/extensionsRegistry";
import { LifecyclePhase } from "vs/workbench/services/lifecycle/common/lifecycle";
import {
	CodeActionsContribution,
	editorConfiguration,
} from "./codeActionsContribution";
