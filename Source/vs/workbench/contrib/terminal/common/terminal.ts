...
import type { MarshalledId } from "vs/base/common/marshallingIds";
import type {
	IProcessEnvironment,
	OperatingSystem,
...
import type { IExtensionPointDescriptor } from "vs/workbench/services/extensions/common/extensionsRegistry";
