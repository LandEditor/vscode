...
} from "vs/workbench/contrib/terminal/common/remote/terminal";
import type { ICompleteTerminalConfiguration } from "vs/workbench/contrib/terminal/common/terminal";
