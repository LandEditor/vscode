...
import type { Orientation } from "vs/base/browser/ui/splitview/splitview";
...
import type { IKeyMods } from "vs/platform/quickinput/common/quickInput";
import type {
	IMarkProperties,
...
import type { IMergedEnvironmentVariableCollection } from "vs/platform/terminal/common/environmentVariable";
import type {
...
import type { ITerminalStatusList } from "vs/workbench/contrib/terminal/browser/terminalStatusList";
import type { IXtermCore } from "vs/workbench/contrib/terminal/browser/xterm-private";
import type { ScrollPosition } from "vs/workbench/contrib/terminal/browser/xterm/markNavigationAddon";
