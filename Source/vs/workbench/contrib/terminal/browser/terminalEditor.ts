...
import type { IBaseActionViewItemOptions } from "vs/base/browser/ui/actionbar/actionViewItems";
...
import type { TerminalEditorInput } from "vs/workbench/contrib/terminal/browser/terminalEditorInput";
