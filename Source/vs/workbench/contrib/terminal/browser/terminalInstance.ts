...
import { type ISeparator, template } from "vs/base/common/labels";
import {
	Disposable,
	DisposableStore,
	type IDisposable,
...
import type { IEnvironmentVariableInfo } from "vs/workbench/contrib/terminal/common/environmentVariable";
import {
	getCommandHistory,
	getDirectoryHistory,
