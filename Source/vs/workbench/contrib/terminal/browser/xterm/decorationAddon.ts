...
export class DecorationAddon extends Disposable implements ITerminalAddon {
	...
	private _capabilityDisposables: Map<TerminalCapability, IDisposable[]> =
		new Map();
	...
	constructor(
		...
		this._terminalDecorationHoverService =
	...
	private _createDisposables(
		...
		return [
			...
			this._terminalDecorationHoverService.createHover(element, command),
		];
	}
