...
export class TerminalGroup extends Disposable implements ITerminalGroup {
		...
		if (this._splitPaneContainer) {
			...
			if (terminalPositionChanged) {
				const newOrientation =
					...
					newPanelPosition === Position.BOTTOM
						? Orientation.HORIZONTAL
						: Orientation.VERTICAL;
	...
	private _getOrientation(): Orientation {
		return this._getPosition() === Position.BOTTOM
			? Orientation.HORIZONTAL
			: Orientation.VERTICAL;
	}
	...
	resizePane(direction: Direction): void {
		...
		if (charSize) {
			...
			if (shouldResizePart) {
				const shouldShrink =
					(this._getPosition() === Position.LEFT &&
						direction === Direction.Left) ||
					(this._getPosition() === Position.RIGHT &&
						direction === Direction.Right) ||
					(this._getPosition() === Position.BOTTOM &&
