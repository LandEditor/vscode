...
import {
	...
	MultiDiffEditorInputData,
} from "vs/workbench/contrib/multiDiffEditor/browser/multiDiffEditorInput";
import {
	...
	deserialize(
		...
		try {
			const data = parse(serializedEditor) as {
				...
				resources: MultiDiffEditorInputData[];
				id: string;
			};
...
export class GoToFileAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("goToFile", "Open File"),
				original: "Open File",
			},
...
export class CollapseAllAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("collapseAllDiffs", "Collapse All Diffs"),
...
export class ExpandAllAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("ExpandAllDiffs", "Expand All Diffs"),
