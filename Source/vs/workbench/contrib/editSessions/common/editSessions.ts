...
import type { IResourceRefHandle } from "vs/platform/userDataSync/common/userDataSync";
import type { EditSessionsStoreClient } from "vs/workbench/contrib/editSessions/common/editSessionsStorageClient";
