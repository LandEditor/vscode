...
const continueWorkingOnCommand: IAction2Options = {
	...
	title: {
		value: localize("continue working on", "Continue Working On..."),
		original: "Continue Working On...",
	},
	...
	implements IWorkbenchContribution
{
	...
	private accountsMenuBadgeDisposable = this._register(
					...
					constructor() {
						super({
							...
							title: {
								...
								original: "Resume Latest Changes from Cloud",
							},
							category: EDIT_SESSION_SYNC_CATEGORY,
							f1: true,
						});
					...
					constructor() {
						super({
							...
							title: {
								...
								original: "Resume Changes from Serialized Data",
							},
							category: "Developer",
							f1: true,
						});
					...
					constructor() {
						super({
							...
							title: {
								...
								original: "Store Working Changes in Cloud",
							},
							category: EDIT_SESSION_SYNC_CATEGORY,
							f1: true,
						});
	...
	private getChangedResources(repository: ISCMRepository) {
		return repository.provider.groups.elements.reduce(
