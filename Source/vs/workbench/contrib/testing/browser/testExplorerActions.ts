...
} from "vs/workbench/contrib/testing/common/testProfileService";
...
import {
	...
	testsInFile,
} from "vs/workbench/contrib/testing/common/testService";
import {
	...
	public override async run(
		...
		for (const element of elements) {
			...
			const profiles = profileService
				.getGroupDefaultProfiles(TestRunProfileBitset.Run)
				.filter(
					(p) =>
						p.supportsContinuousRun &&
						p.controllerId === element.test.controllerId
				);
			if (!profiles.length) {
				continue;
			}
...
export class GetSelectedProfiles extends Action2 {
	constructor() {
		super({
			...
			title: localize("getSelectedProfiles", "Get Selected Profiles"),
		});
	}
...
export class GetExplorerSelection extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			title: localize("getExplorerSelection", "Get Explorer Selection"),
			viewId: Testing.ExplorerViewId,
		});
	}
...
export class CancelTestRunAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.cancelRun", "Cancel Test Run"),
...
export class TestingViewAsListAction extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			viewId: Testing.ExplorerViewId,
			title: {
				value: localize("testing.viewAsList", "View as List"),
...
export class TestingViewAsTreeAction extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			viewId: Testing.ExplorerViewId,
			title: {
				value: localize("testing.viewAsTree", "View as Tree"),
...
export class TestingSortByStatusAction extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			viewId: Testing.ExplorerViewId,
			title: {
				value: localize("testing.sortByStatus", "Sort by Status"),
...
export class TestingSortByLocationAction extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			viewId: Testing.ExplorerViewId,
			title: {
				value: localize("testing.sortByLocation", "Sort by Location"),
...
export class TestingSortByDurationAction extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			viewId: Testing.ExplorerViewId,
			title: {
				value: localize("testing.sortByDuration", "Sort by Duration"),
...
export class ShowMostRecentOutputAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.showMostRecentOutput", "Show Output"),
...
export class CollapseAllAction extends ViewAction<TestingExplorerView> {
	constructor() {
		super({
			...
			viewId: Testing.ExplorerViewId,
			title: {
				value: localize("testing.collapseAll", "Collapse All Tests"),
...
export class ClearTestResultsAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.clearResults", "Clear All Results"),
...
export class GoToTest extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.editFocusedTest", "Go to Test"),
				original: "Go to Test",
			},
...
abstract class ExecuteTestAtCursor extends Action2 {
	...
	public async run(accessor: ServicesAccessor) {
		...
		await showDiscoveringWhile(
			...
			(async () => {
				for await (const test of testsInFile(
					...
					if (
						!test.item.range ||
						!(profileService.capabilitiesForTest(test) & this.group)
					) {
						continue;
					}
					...
					if (irange.containsPosition(position)) {
						if (
							bestRange &&
							Range.equalsRange(test.item.range, bestRange)
						) {
						...
						Position.isBefore(irange.getStartPosition(), position)
					) {
						if (
							!bestRangeBefore ||
							bestRangeBefore
		...
		if (testsToRun.length) {
			...
			MessageController.get(activeControl)?.showMessage(
...
abstract class ExecuteTestsInCurrentFile extends Action2 {
	...
	public run(accessor: ServicesAccessor) {
		...
		if (isCodeEditor(control)) {
			MessageController.get(control)?.showMessage(
...
export class ReRunFailedTests extends RunOrDebugFailedTests {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.reRunFailTests", "Rerun Failed Tests"),
...
export class DebugFailedTests extends RunOrDebugFailedTests {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.debugFailTests", "Debug Failed Tests"),
...
export class ReRunLastRun extends RunOrDebugLastRun {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.reRunLastRun", "Rerun Last Run"),
...
export class DebugLastRun extends RunOrDebugLastRun {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.debugLastRun", "Debug Last Run"),
...
export class OpenOutputPeek extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.openOutputPeek", "Peek Output"),
...
export class RefreshTestsAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("testing.refreshTests", "Refresh Tests"),
