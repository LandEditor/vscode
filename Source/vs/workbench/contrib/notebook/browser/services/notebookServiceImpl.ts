...
import type * as glob from "vs/base/common/glob";
...
import type { INotebookEditorOptions } from "vs/workbench/contrib/notebook/browser/notebookBrowser";
import {
	type INotebookEditorContribution,
	notebookPreloadExtensionPoint,
	notebookRendererExtensionPoint,
	notebooksExtensionPoint,
} from "vs/workbench/contrib/notebook/browser/notebookExtensionPoint";
...
} from "vs/workbench/contrib/notebook/common/notebookOutputRenderer";
import {
	type NotebookEditorDescriptor,
	NotebookProviderInfo,
} from "vs/workbench/contrib/notebook/common/notebookProvider";
import {
...
import type { IExtensionPointUser } from "vs/workbench/services/extensions/common/extensionsRegistry";
import {
	type INotebookDocument,
	INotebookDocumentService,
} from "vs/workbench/services/notebook/common/notebookDocumentService";
	...
	private _registerContributionPoint(
		...
		for (const selector of notebookProviderInfo.selectors) {
			...
			const notebookEditorInfo: RegisteredEditorInfo = {
				...
				priority: notebookProviderInfo.exclusive
			...
			const notebookDiffEditorInputFactory: DiffEditorInputFactoryFunction =
				({ modified, original, label, description }) => {
					return {
