...
import type { NotebookEditorSimpleWorker } from "vs/workbench/contrib/notebook/common/services/notebookSimpleWorker";
import type { INotebookWorkerHost } from "vs/workbench/contrib/notebook/common/services/notebookWorkerHost";
import type { INotebookEditorWorkerService } from "vs/workbench/contrib/notebook/common/services/notebookWorkerService";
		...
		toDispose.add(
			model.onDidChangeContent((event) => {
				const dto = event.rawEvents.map((e) => {
					const data =
						e.kind === NotebookCellsChangeType.ModelChange ||
