...
import type { ICommandActionTitle } from "vs/platform/action/common/action";
import {
	Action2,
	MenuId,
	registerAction2,
...
import type { NotebookDiffEditorInput } from "vs/workbench/contrib/notebook/common/notebookDiffEditorInput";
