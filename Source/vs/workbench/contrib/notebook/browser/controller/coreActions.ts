...
import type { TypeConstraint } from "vs/base/common/types";
...
import type { IEditorCommandsContext } from "vs/workbench/common/editor";
import {
...
export abstract class NotebookMultiCellAction extends Action2 {
	...
	private isEditorContext(context?: unknown): boolean {
		return (
			!!context &&
			(context as IEditorCommandsContext).groupId !== undefined
		);
	}
