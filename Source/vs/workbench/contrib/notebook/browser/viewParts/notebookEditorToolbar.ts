...
import { type IAction, Separator } from "vs/base/common/actions";
...
import type { INotebookEditorDelegate } from "vs/workbench/contrib/notebook/browser/notebookBrowser";
import type { NotebookOptions } from "vs/workbench/contrib/notebook/browser/notebookOptions";
import {
	ActionViewWithLabel,
	UnifiedSubmenuActionView,
} from "vs/workbench/contrib/notebook/browser/view/cellParts/cellActionView";
