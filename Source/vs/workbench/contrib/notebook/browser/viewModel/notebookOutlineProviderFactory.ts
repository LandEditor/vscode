...
import { type IReference, ReferenceCollection } from "vs/base/common/lifecycle";
import {
...
class NotebookCellOutlineProviderReferenceCollection extends ReferenceCollection<NotebookCellOutlineProvider> {
	...
	protected override destroyReferencedObject(
		_key: string,
		object: NotebookCellOutlineProvider,
	): void {
		object.dispose();
	}
}

export const INotebookCellOutlineProviderFactory =
	createDecorator<INotebookCellOutlineProviderFactory>(
...
export class NotebookCellOutlineProviderFactory
	implements INotebookCellOutlineProviderFactory
{
