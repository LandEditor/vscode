...
import type { FoldingLimitReporter } from "vs/editor/contrib/folding/browser/folding";
import {
	type FoldingRegion,
	FoldingRegions,
} from "vs/editor/contrib/folding/browser/foldingRanges";
import {
	type IFoldingRangeData,
	sanitizeRanges,
} from "vs/editor/contrib/folding/browser/syntaxRangeProvider";
import type { INotebookViewModel } from "vs/workbench/contrib/notebook/browser/notebookBrowser";
