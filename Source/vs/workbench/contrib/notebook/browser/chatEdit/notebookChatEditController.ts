...
class NotebookChatEditorController extends Disposable {
	...
	constructor(
		...
		const snapshotCreated = observableValue<boolean>(
			"snapshotCreated",
			false,
		);
