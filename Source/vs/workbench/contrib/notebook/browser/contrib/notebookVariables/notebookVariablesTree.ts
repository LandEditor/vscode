...
import type { ITreeNode, ITreeRenderer } from "vs/base/browser/ui/tree/tree";
...
import type { INotebookVariableElement } from "vs/workbench/contrib/notebook/browser/contrib/notebookVariables/notebookVariablesDataSource";
