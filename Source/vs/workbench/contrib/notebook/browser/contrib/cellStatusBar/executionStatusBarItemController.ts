...
} from "vs/workbench/contrib/notebook/browser/contrib/cellStatusBar/notebookVisibleCellObserver";
import {
	ICellViewModel,
	INotebookEditor,
...
} from "vs/workbench/contrib/notebook/browser/notebookEditorWidget";
import {
	errorStateIcon,
	executingStateIcon,
	pendingStateIcon,
			...
			for (const key in renderDuration) {
				...
				const args = encodeURIComponent(
					JSON.stringify({
						...
						issueBody:
							`Auto-generated text from notebook cell performance. The duration for the renderer, ${
