...
import type { CellTitleToolbarPart } from "vs/workbench/contrib/notebook/browser/view/cellParts/cellToolbars";
...
export class CellFocusIndicator extends CellContentPart {
	...
	override updateInternalLayoutNow(element: ICellViewModel): void {
		if (element.cellKind === CellKind.Markup) {
			...
			this.bottom.domNode.style.transform = `translateY(${
				cell.layoutInfo.totalHeight -
				bottomToolbarDimensions.bottomToolbarGap -
				layoutInfo.cellBottomMargin
			}px)`;
		}
