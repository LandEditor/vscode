...
import {
	...
	CellDragAndDropPart,
} from "vs/workbench/contrib/notebook/browser/view/cellParts/cellDnd";
...
} from "vs/workbench/contrib/notebook/browser/view/cellParts/cellToolbars";
	...
	implements IListRenderer<MarkupCellViewModel, MarkdownCellRenderTemplate>
{
	...
	renderTemplate(rootContainer: HTMLElement): MarkdownCellRenderTemplate {
		...
		const scopedInstaService = this.instantiationService.createChild(
