...
import type { IListContextMenuEvent } from "vs/base/browser/ui/list/list";
...
import { BareFontInfo, type FontInfo } from "vs/editor/common/config/fontInfo";
import type { IDimension } from "vs/editor/common/core/dimension";
...
import type { NotebookPerfMarks } from "vs/workbench/contrib/notebook/common/notebookPerformance";
	...
	implements INotebookEditorDelegate, INotebookEditor
{
	...
	private _registerNotebookStickyScroll() {
		...
		this._register(
			this._notebookStickyScroll.onDidChangeNotebookStickyScroll(
				(sizeDelta) => {
					const d = localDisposableStore.add(
