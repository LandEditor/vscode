...
} from "vs/workbench/contrib/notebook/browser/viewModel/notebookOutlineProviderFactory";
...
import {
	NotebookEditorInput,
	type NotebookEditorInputOptions,
...
import type { NotebookInfo } from "vs/editor/common/languageFeatureRegistry";
...
class NotebookDiffEditorSerializer implements IEditorSerializer {
	...
	deserialize(instantiationService: IInstantiationService, raw: string) {
		...
		const input = NotebookDiffEditorInput.create(
