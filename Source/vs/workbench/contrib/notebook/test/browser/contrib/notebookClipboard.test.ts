...
import {
	...
	runCopyCells,
	runCutCells,
} from "vs/workbench/contrib/notebook/browser/contrib/clipboard/notebookClipboard";
import {
	CellKind,
	NOTEBOOK_EDITOR_ID,
	SelectionStateType,
...
suite("Notebook Clipboard", () => {
	...
	const createEditorService = (editor: IActiveNotebookEditor) => {
		const visibleEditorPane =
			new (class extends mock<IVisibleEditorPane>() {
