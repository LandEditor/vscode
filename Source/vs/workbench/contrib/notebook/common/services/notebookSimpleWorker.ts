 ...
 *--------------------------------------------------------------------------------------------*/
import { type ISequence, LcsDiff } from "vs/base/common/diff/diff";
import { doHash, hash, numberHash } from "vs/base/common/hash";
import type { IDisposable } from "vs/base/common/lifecycle";
import { URI } from "vs/base/common/uri";
import type { IRequestHandler } from "vs/base/common/worker/simpleWorker";
 ...
 */
	...
	canPromptRecommendation(modelUrl: string): boolean {
		...
		for (let i = 0; i < cells.length; i++) {
			...
			const cellMatches = cell.textBuffer.findMatchesLineByLine(
				range,
				searchData,
				true,
				1,
