...
import type { ICodeEditorWidgetOptions } from "vs/editor/browser/widget/codeEditor/codeEditorWidget";
...
} from "vs/workbench/contrib/searchEditor/browser/constants";
import type {
	SearchConfiguration,
	SearchEditorInput,
	...
	private createQueryEditor(
		...
		this._register(
			this.hoverService.setupUpdatableHover(
				...
				localize("moreSearch", "Toggle Search Details"),
			),
		);
		this._register(
