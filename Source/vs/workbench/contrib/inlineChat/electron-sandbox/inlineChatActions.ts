...
import type { Action2 } from "vs/platform/actions/common/actions";
...
import type { IChatExecuteActionContext } from "vs/workbench/contrib/chat/browser/actions/chatExecuteActions";
import {
...
import {
	...
	setHoldForSpeech,
} from "vs/workbench/contrib/inlineChat/browser/inlineChatActions";
import type { InlineChatController } from "vs/workbench/contrib/inlineChat/browser/inlineChatController";
import {
