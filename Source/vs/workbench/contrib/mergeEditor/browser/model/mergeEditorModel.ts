...
import type { IMergeDiffComputer } from "vs/workbench/contrib/mergeEditor/browser/model/diffComputer";
...
import type { MergeEditorTelemetry } from "vs/workbench/contrib/mergeEditor/browser/telemetry";
...
export enum MergeEditorModelState {
	initializing = 1,
	upToDate = 2,
	updating = 3,
}
