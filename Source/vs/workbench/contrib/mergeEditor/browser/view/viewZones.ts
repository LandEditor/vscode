...
import type { IObservable, IReader } from "vs/base/common/observable";
import type {
	ICodeEditor,
	IViewZoneChangeAccessor,
} from "vs/editor/browser/editorBrowser";
import { LineRange } from "vs/workbench/contrib/mergeEditor/browser/model/lineRange";
import type { DetailedLineRangeMapping } from "vs/workbench/contrib/mergeEditor/browser/model/mapping";
import type { ModifiedBaseRange } from "vs/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange";
import { join } from "vs/workbench/contrib/mergeEditor/browser/utils";
import {
	ActionsSource,
	ConflictActionsFactory,
	type IContentWidgetAction,
} from "vs/workbench/contrib/mergeEditor/browser/view/conflictActions";
