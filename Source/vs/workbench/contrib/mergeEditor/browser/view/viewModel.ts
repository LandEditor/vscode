...
import type { MergeEditorModel } from "vs/workbench/contrib/mergeEditor/browser/model/mergeEditorModel";
import type {
	InputNumber,
	ModifiedBaseRange,
	ModifiedBaseRangeState,
} from "vs/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange";
import type { BaseCodeEditorView } from "vs/workbench/contrib/mergeEditor/browser/view/editors/baseCodeEditorView";
import type { CodeEditorView } from "vs/workbench/contrib/mergeEditor/browser/view/editors/codeEditorView";
import type { InputCodeEditorView } from "vs/workbench/contrib/mergeEditor/browser/view/editors/inputCodeEditorView";
import type { ResultCodeEditorView } from "vs/workbench/contrib/mergeEditor/browser/view/editors/resultCodeEditorView";
