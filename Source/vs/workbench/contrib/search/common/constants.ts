...
export const QuickTextSearchActionId =
	"workbench.action.experimental.quickTextSearch";
export const CancelSearchActionId = "search.action.cancel";
export const RefreshSearchResultsActionId =
	"search.action.refreshSearchResults";
export const FocusNextSearchResultActionId =
	"search.action.focusNextSearchResult";
export const FocusPreviousSearchResultActionId =
	"search.action.focusPreviousSearchResult";
export const ToggleSearchOnTypeActionId = "workbench.action.toggleSearchOnType";
export const CollapseSearchResultsActionId =
...
export const ToggleQueryDetailsActionId =
