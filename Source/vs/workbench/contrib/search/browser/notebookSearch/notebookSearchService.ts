...
import type { INotebookExclusiveDocumentFilter } from "vs/workbench/contrib/notebook/common/notebookCommon";
...
import type { INotebookSearchService } from "vs/workbench/contrib/search/common/notebookSearch";
...
export class NotebookSearchService implements INotebookSearchService {
	...
	private async doesFileExist(
		...
		const promises: Promise<void>[] = includes.map(
