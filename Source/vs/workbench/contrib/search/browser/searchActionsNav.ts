...
} from "vs/editor/contrib/find/browser/findModel";
...
import type { ICommandHandler } from "vs/platform/commands/common/commands";
...
import type { WorkbenchCompressibleObjectTree } from "vs/platform/list/browser/listService";
import {
	category,
	getSearchView,
	openSearchView,
