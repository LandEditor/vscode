...
export const MENU_TERMINAL_CHAT_WIDGET_FEEDBACK = MenuId.for(
	"terminalChatWidget.feedback",
);
...
export namespace TerminalChatContextKeys {
	...
	export const agentRegistered = new RawContextKey<boolean>(
	...
	export const responseSupportsIssueReporting = new RawContextKey<boolean>(
		TerminalChatContextKeyStrings.ChatResponseSupportsIssueReporting,
		false,
		localize(
	...
	export const sessionResponseVote = new RawContextKey<string>(
		TerminalChatContextKeyStrings.ChatSessionResponseVote,
		undefined,
		{
			type: "string",
