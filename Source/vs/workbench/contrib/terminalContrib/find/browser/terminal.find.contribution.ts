...
registerActiveInstanceAction({
	...
	title: {
		value: localize("workbench.action.terminal.focusFind", "Focus Find"),
		original: "Focus Find",
	},
	keybinding: {
...
registerActiveInstanceAction({
	...
	title: {
		value: localize("workbench.action.terminal.hideFind", "Hide Find"),
		original: "Hide Find",
	},
	keybinding: {
...
registerActiveInstanceAction({
	...
	run: (activeInstance) => {
		const state =
			TerminalFindContribution.get(activeInstance)?.findWidget.state;
...
registerActiveInstanceAction({
	...
	title: {
		value: localize("workbench.action.terminal.findNext", "Find Next"),
		original: "Find Next",
	},
	keybinding: [
		{
