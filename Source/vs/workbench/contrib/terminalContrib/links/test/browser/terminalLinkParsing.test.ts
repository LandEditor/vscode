...
const testLinks: ITestLink[] = [
	...
	{
		link: "foo 339.12-341.14",
		prefix: undefined,
		suffix: " 339.12-341.14",
		hasRow: true,
		hasCol: true,
		hasRowEnd: true,
		hasColEnd: true,
	...
	{
		link: '"foo", line 339, characters 12-14',
		prefix: '"',
		suffix: '", line 339, characters 12-14',
		hasRow: true,
		hasCol: true,
		hasColEnd: true,
	},
	...
	{
		link: '"foo", lines 339-341, characters 12-14',
		prefix: '"',
		suffix: '", lines 339-341, characters 12-14',
		hasRow: true,
		hasCol: true,
		hasRowEnd: true,
		hasColEnd: true,
				...
				deepStrictEqual(
					...
					testLink.suffix === undefined
						...
						: ({
								...
								rowEnd: testLink.hasRowEnd
									? testRowEnd
									: undefined,
								colEnd: testLink.hasColEnd
									? testColEnd
									: undefined,
								suffix: {
									index:
										testLink.link.length -
										testLink.suffix.length,
					...
					const detectedLink1: IParsedLink = {
						...
						suffix: {
							...
							suffix: {
								index:
									1 +
									(link1.link.length - link1.suffix.length),
								text: link1.suffix,
							},
						},
					};
