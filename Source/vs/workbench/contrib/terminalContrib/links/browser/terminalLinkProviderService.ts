...
import type { ITerminalExternalLinkProvider } from "vs/workbench/contrib/terminal/browser/terminal";
import type { ITerminalLinkProviderService } from "vs/workbench/contrib/terminalContrib/links/browser/links";
