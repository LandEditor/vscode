...
import {
	IDetectedLinks,
	TerminalLinkManager,
} from "vs/workbench/contrib/terminalContrib/links/browser/terminalLinkManager";
	...
	implements ITerminalContribution
{
	...
	get linkManager(): TerminalLinkManager | undefined {
	...
	xtermReady(xterm: IXtermTerminal & { raw: RawXtermTerminal }): void {
		const linkManager = this._instantiationService.createInstance(
			TerminalLinkManager,
			xterm.raw,
