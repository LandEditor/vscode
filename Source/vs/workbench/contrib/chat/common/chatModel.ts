			...
			if (
				...
				if (progress.kind === "content") {
					this._responseParts.push({
						content: new MarkdownString(progress.content),
						kind: "markdownContent",
					});
				} else {
				...
				const lastPartEnabledCommands =
					typeof lastResponsePart.content.isTrusted === "object"
						? lastResponsePart.content.isTrusted.enabledCommands
						: [];
				const thisPartEnabledCommands =
					typeof progress.content.isTrusted === "object"
						? progress.content.isTrusted.enabledCommands
						: [];
				const enabledCommands = [
					...lastPartEnabledCommands,
