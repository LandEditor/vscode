...
export const CONTEXT_ITEM_ID = new RawContextKey<string>("chatItemId", "", {
	type: "string",
	description: localize("chatItemId", "The id of the chat item."),
});
export const CONTEXT_LAST_ITEM_ID = new RawContextKey<string[]>(
	"chatLastItemId",
	[],
	{
		type: "string",
...
export const CONTEXT_CHAT_EDITING_PARTICIPANT_REGISTERED =
	new RawContextKey<boolean>("chatEditingParticipantRegistered", false, {
		type: "boolean",
		description: localize(
...
export const CONTEXT_LANGUAGE_MODELS_ARE_USER_SELECTABLE =
	new RawContextKey<boolean>("chatModelsAreUserSelectable", false, {
		type: "boolean",
		description: localize(
...
export const CONTEXT_PARTICIPANT_SUPPORTS_MODEL_PICKER =
	new RawContextKey<boolean>("chatParticipantSupportsModelPicker", true, {
		type: "boolean",
		description: localize(
