...
import {
	getMoveToEditorAction,
	getMoveToNewWindowAction,
} from "vs/workbench/contrib/chat/browser/actions/chatMoveActions";
...
import {
	...
	IRawChatProviderContribution,
} from "vs/workbench/contrib/chat/common/chatContributionService";
import * as extensionsRegistry from "vs/workbench/services/extensions/common/extensionsRegistry";
import { LifecyclePhase } from "vs/workbench/services/lifecycle/common/lifecycle";

const chatExtensionPoint =
...
export class ChatExtensionPointHandler implements IWorkbenchContribution {
	...
	constructor(
		@IChatContributionService
		readonly _chatContributionService: IChatContributionService
	) {
		...
		const viewDescriptor: IViewDescriptor[] = [
			{
				...
				name: {
					value: providerDescriptor.label,
					original: providerDescriptor.label,
				},
				canToggleVisibility: false,
				canMoveView: true,
				ctorDescriptor: new SyncDescriptor(ChatViewPane, [
					<IChatViewOptions>{ providerId: providerDescriptor.id },
				]),
