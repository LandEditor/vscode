...
const viewContainer = Registry.as<IViewContainersRegistry>(
...
).registerViewContainer(
	{
		id: VIEWLET_ID,
		title: {
			value: localize("source control", "Source Control"),
	...
	properties: {
		...
		"scm.providerCountBadge": {
			...
			markdownDescription: localize(
				"scm.providerCountBadge",
				'Controls the count badges on Source Control Provider headers. These headers appear in the "Source Control", and "Source Control Sync" views when there is more than one provider or when the {0} setting is enabled, as well as in the "Source Control Repositories" view.',
