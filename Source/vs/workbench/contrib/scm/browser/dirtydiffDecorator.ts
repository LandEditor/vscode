...
import type { IActionBarOptions } from "vs/base/browser/ui/actionbar/actionbar";
import { Action, ActionRunner, type IAction } from "vs/base/common/actions";
...
import type { IChange } from "vs/editor/common/diff/legacyLinesDiffComputer";
import {
...
import type * as ext from "vs/workbench/common/contributions";
import {
	type IQuickDiffSelectItem,
	SwitchQuickDiffBaseAction,
	SwitchQuickDiffViewItem,
} from "vs/workbench/contrib/scm/browser/dirtyDiffSwitcher";
import {
	IQuickDiffService,
	type QuickDiff,
