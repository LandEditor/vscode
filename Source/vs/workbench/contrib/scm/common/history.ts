...
import type { ISCMRepository } from "vs/workbench/contrib/scm/common/scm";
...
export interface ISCMHistoryProvider {
	...
	resolveHistoryItemGroupCommonAncestor(
		...
		historyItemGroupId2: string | undefined,
...
export interface ISCMHistoryProviderCacheEntry {
	readonly incomingHistoryItemGroup:
		...
		| undefined;
	readonly outgoingHistoryItemGroup:
		| SCMHistoryItemGroupTreeElement
		| undefined;
	readonly historyItems: Map<
		string,
