...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		...
		title: {
			value: nls.localize("ReRunTaskAction.label", "Rerun Last Task"),
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		id: "workbench.action.tasks.showTasks",
		title: {
			value: nls.localize("ShowTasksAction.label", "Show Running Tasks"),
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		id: "workbench.action.tasks.terminate",
		title: {
			value: nls.localize("TerminateAction.label", "Terminate Task"),
