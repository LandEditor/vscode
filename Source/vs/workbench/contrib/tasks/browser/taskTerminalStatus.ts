...
import type { IMarker } from "vs/platform/terminal/common/capabilities/capabilities";
...
import type { ITerminalStatus } from "vs/workbench/contrib/terminal/common/terminal";
