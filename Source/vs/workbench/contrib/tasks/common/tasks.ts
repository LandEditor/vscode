...
import type { IJSONSchemaMap } from "vs/base/common/jsonSchema";
...
import type { TerminalExitReason } from "vs/platform/terminal/common/terminal";
import type {
	IWorkspace,
	IWorkspaceFolder,
} from "vs/platform/workspace/common/workspace";
import type { ProblemMatcher } from "vs/workbench/contrib/tasks/common/problemMatcher";
...
export class CustomTask extends CommonTask {
	...
	public override getDefinition(useSource = false): KeyedTaskIdentifier {
...
export enum TasksSchemaProperties {
	Tasks = "tasks",
