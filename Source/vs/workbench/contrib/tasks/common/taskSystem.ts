...
import type { Platform } from "vs/base/common/platform";
import type { TerminateResponse } from "vs/base/common/processes";
...
import type { ITaskEvent, KeyedTaskIdentifier, Task } from "./tasks";
