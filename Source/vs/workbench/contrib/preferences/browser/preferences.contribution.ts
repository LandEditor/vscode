...
} from "vs/workbench/contrib/preferences/browser/settingsEditor2";
import {
...
const OPEN_USER_SETTINGS_UI_TITLE = {
	value: nls.localize("openSettings2", "Open Settings (UI)"),
	original: "Open Settings (UI)",
};
const OPEN_USER_SETTINGS_JSON_TITLE = {
	value: nls.localize("openUserSettingsJson", "Open User Settings (JSON)"),
	original: "Open User Settings (JSON)",
};
...
const category = {
	value: nls.localize("preferences", "Preferences"),
				...
				class extends Action2 {
					constructor() {
						super({
							...
							title: {
								value: label,
								original: `Open Remote Settings (${hostLabel})`,
							},
							category,
							menu: {
								id: MenuId.CommandPalette,
				...
				class extends Action2 {
					constructor() {
						super({
							...
							title: {
								value: jsonLabel,
								original: `Open Remote Settings (JSON) (${hostLabel})`,
							},
							category,
							menu: {
								id: MenuId.CommandPalette,
