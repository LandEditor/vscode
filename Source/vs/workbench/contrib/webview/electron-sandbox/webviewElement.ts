...
import type { VSBuffer, VSBufferReadableStream } from "vs/base/common/buffer";
...
} from "vs/platform/webview/common/webviewManagerService";
import type { WebviewThemeDataProvider } from "vs/workbench/contrib/webview/browser/themeing";
import type { WebviewInitInfo } from "vs/workbench/contrib/webview/browser/webview";
