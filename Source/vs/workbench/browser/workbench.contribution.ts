		...
		"properties": {
			...
			"workbench.editor.editorActionsLocation": {
				...
				"enumDescriptions": [
					...
					localize(
						...
						"Show editor actions in the window title bar. If `#window.titleBarStyle#` is set to `native`, editor actions are hidden."
					),
					localize(
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				"markdownDescription": localize(
					...
					"Controls the location of the activity bar. It can either show to the `side` or `top` (requires {0} set to {1}) of the primary side bar or `hidden`.",
