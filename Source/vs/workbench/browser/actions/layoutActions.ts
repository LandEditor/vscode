	...
	class extends Action2 {
		constructor() {
			super({
				...
				title: {
					value: localize("closeSidebar", "Close Primary Side Bar"),
...
export class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
	...
	constructor() {
		...
		const title = {
			...
			original: "Hide Editor Tabs in Zen Mode",
		};
		super(
...
export class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
	...
	constructor() {
		...
		const title = {
			...
			original: "Show Multiple Editor Tabs in Zen Mode",
		};
...
export class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
	...
	constructor() {
		...
		const title = {
			...
			original: "Show Single Editor Tab in Zen Mode",
		};
...
if (isWindows || isLinux || isWeb) {
	...
	for (const menuId of [
		...
		MenuRegistry.appendMenuItem(menuId, {
			...
			group:
				menuId === MenuId.TitleBarTitleContext ? "2_config" : undefined,
			order: 0,
		});
	}
}
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
	constructor() {
		super({
			...
			title: {
				value: localize("increaseEditorWidth", "Increase Editor Width"),
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
	constructor() {
		super({
			...
			title: {
				value: localize("decreaseEditorWidth", "Decrease Editor Width"),
...
ToggleVisibilityActions.push(
	...[
		CreateToggleLayoutItem(
			...
			ContextKeyExpr.equals("config.workbench.activityBar.visible", true),
		...
		constructor() {
			super({
				...
				title: {
					...
					value: localize("customizeLayout", "Customize Layout..."),
				},
				f1: true,
				icon: configureLayoutIcon,
				menu: [
