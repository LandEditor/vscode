...
export class Workbench extends Layout {
	...
	private registerErrorHandler(logService: ILogService): void {
		...
		this._register(
			addDisposableListener(window, "unhandledrejection", (event) => {
	...
	private registerListeners(
		...
		this._register(
			dialogService.onWillShowDialog(() =>
				this.container.classList.add("modal-dialog-visible")
			)
		);
		this._register(
			dialogService.onDidShowDialog(() =>
				this.container.classList.remove("modal-dialog-visible")
			)
		);
	}
