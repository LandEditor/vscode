...
export abstract class BreadcrumbsPicker {
	...
	async show(
		...
		this._arrow.style.borderColor = `transparent transparent ${
		...
		this._treeContainer.style.boxShadow = `0 0 8px 2px ${this._themeService
			.getColorTheme()
			.getColor(widgetShadow)}`;
		this._treeContainer.style.border = `1px solid ${this._themeService
			.getColorTheme()
			.getColor(widgetBorder)}`;
