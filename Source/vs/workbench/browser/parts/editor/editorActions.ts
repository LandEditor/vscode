...
import {
	GoFilter,
	IHistoryService,
} from "vs/workbench/services/history/common/history";
...
abstract class AbstractSplitEditorAction extends Action2 {
	...
	override async run(
		...
		splitEditor(
			editorGroupService,
			this.getDirection(configurationService),
			context
		);
	}
}
...
export class SplitEditorAction extends AbstractSplitEditorAction {
	...
	constructor() {
		super({
			...
			title: {
				value: localize("splitEditor", "Split Editor"),
		...
		super(
			{
				id: SPLIT_EDITOR_UP,
				title: {
					value: localize("splitEditorGroupUp", "Split Editor Up"),
...
export class JoinAllGroupsAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("joinAllGroups", "Join All Editor Groups"),
	...
	override async run(accessor: ServicesAccessor): Promise<void> {
		...
		for (const { editor, groupId } of editorService.getEditors(
			...
			// dialog appears, so just track that separate
				...
				filesConfigurationService.getAutoSaveMode() ===
		...
		for (const [, editorIdentifiers] of editorsWithCustomConfirm) {
			...
			const confirmation =
				await firstOrDefault(editors)?.editor.closeHandler?.confirm?.(
					editors
				);
...
export class CloseAllEditorsAction extends AbstractCloseAllAction {
	...
	static readonly LABEL = {
		value: localize("closeAllEditors", "Close All Editors"),
...
export class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
	constructor() {
		super({
			...
			title: {
				value: localize("closeAllGroups", "Close All Editor Groups"),
...
export class ResetGroupSizesAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("evenEditorGroups", "Reset Editor Group Sizes"),
	...
	constructor() {
		super({
			...
			precondition: ContextKeyExpr.and(
				MaximizedEditorGroupContext.negate(),
				MultipleEditorGroupsContext
			),
		});
	}
...
export class ToggleMaximizeEditorGroupAction extends Action2 {
	...
	override async run(
		...
		const { group } = resolveCommandsContext(
			editorGroupsService,
			getCommandsContext(resourceOrContext, context)
		);
...
export class OpenNextEditor extends AbstractNavigateEditorAction {
	constructor() {
		super({
			...
			title: {
				value: localize("openNextEditor", "Open Next Editor"),
...
export class OpenPreviousEditor extends AbstractNavigateEditorAction {
	constructor() {
		super({
			...
			title: {
				value: localize("openPreviousEditor", "Open Previous Editor"),
...
export class NavigateForwardAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: localize("navigateForward", "Go Forward"),
				original: "Go Forward",
...
export class NavigateBackwardsAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: localize("navigateBack", "Go Back"),
				original: "Go Back",
				mnemonicTitle: localize(
...
export class NavigatePreviousAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("navigatePrevious", "Go Previous"),
...
export class ReopenClosedEditorAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: localize("reopenClosedEditor", "Reopen Closed Editor"),
...
export class ClearRecentFilesAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: {
				value: localize("clearRecentFiles", "Clear Recently Opened"),
...
export class ClearEditorHistoryAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("clearEditorHistory", "Clear Editor History"),
		...
		super(
			{
				...
				title: {
					value: localize("moveEditorLeft", "Move Editor Left"),
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "left" } as ActiveEditorMoveCopyArguments
		);
	}
}
		...
		super(
			{
				...
				title: {
					value: localize("moveEditorRight", "Move Editor Right"),
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "right" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "previous", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToNextGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "next", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "up", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "down", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "left", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToRightGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "right", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "first", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
...
export class MoveEditorToLastGroupAction extends ExecuteCommandAction {
	constructor() {
		super(
			...
			MOVE_ACTIVE_EDITOR_COMMAND_ID,
			{ to: "last", by: "group" } as ActiveEditorMoveCopyArguments
		);
	}
}
		...
		super(
			{
				...
				title: {
					value: localize("newGroupAbove", "New Editor Group Above"),
		...
		super(
			{
				...
				title: {
					value: localize("newGroupBelow", "New Editor Group Below"),
...
export class ToggleEditorTypeAction extends Action2 {
	constructor() {
		super({
			...
			title: {
				value: localize("toggleEditorType", "Toggle Editor Type"),
