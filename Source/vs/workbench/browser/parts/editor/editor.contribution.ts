...
MenuRegistry.appendMenuItem(MenuId.EmptyEditorGroupContext, {
	...
	when: ContextKeyExpr.and(
		MultipleEditorGroupsContext,
		IsAuxiliaryEditorPartContext.toNegated()
	),
});
MenuRegistry.appendMenuItem(MenuId.EmptyEditorGroupContext, {
	command: {
...
MenuRegistry.appendMenuItem(MenuId.EditorTabsBarShowTabsSubmenu, {
	command: {
		...
		title: localize("hideTabBar", "Hide"),
		toggled: ContextKeyExpr.equals(
			"config.workbench.editor.showTabs",
			"none"
		),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitleContext, {
	command: {
		...
		precondition: ActiveEditorLastInGroupContext.toNegated(),
	},
	group: "1_close",
	order: 30,
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		id: KEEP_EDITOR_COMMAND_ID,
		title: {
			value: localize("keepEditor", "Keep Editor"),
			original: "Keep Editor",
		},
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		...
		title: {
			value: localize("pinEditor", "Pin Editor"),
			original: "Pin Editor",
		},
		category: Categories.View,
	},
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		id: UNPIN_EDITOR_COMMAND_ID,
		title: {
			value: localize("unpinEditor", "Unpin Editor"),
			original: "Unpin Editor",
		},
		category: Categories.View,
	},
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		id: CLOSE_EDITOR_COMMAND_ID,
		title: {
			value: localize("closeEditor", "Close Editor"),
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		...
		title: {
			value: localize("closePinnedEditor", "Close Pinned Editor"),
			original: "Close Pinned Editor",
		},
		category: Categories.View,
	},
});
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		...
		title: {
			value: localize("closeEditorGroup", "Close Editor Group"),
			original: "Close Editor Group",
		},
		category: Categories.View,
	},
	when: MultipleEditorGroupsContext,
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
	command: {
		id: REOPEN_WITH_COMMAND_ID,
		title: {
			value: localize("reopenWith", "Reopen Editor With..."),
			original: "Reopen Editor With...",
		},
		category: Categories.View,
	},
	when: ActiveEditorAvailableEditorIdsContext,
