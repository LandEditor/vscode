...
const openChat: WatermarkEntry = {
	...
	when: {
		native: ContextKeyExpr.equals("chatPanelParticipantRegistered", true),
		web: ContextKeyExpr.equals("chatPanelParticipantRegistered", true),
	},
};

const openCopilotEdits: WatermarkEntry = {
	text: localize("watermark.openCopilotEdits", "Open Copilot Edits"),
	id: "workbench.action.chat.openEditSession",
	when: {
		native: ContextKeyExpr.equals("chatEditingParticipantRegistered", true),
		web: ContextKeyExpr.equals("chatEditingParticipantRegistered", true),
	},
};
