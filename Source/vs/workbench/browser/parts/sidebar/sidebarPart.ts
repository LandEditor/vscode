...
export class SidebarPart extends AbstractPaneCompositePart {
	...
	override getPinnedPaneCompositeIds(): string[] {
		return this.shouldShowCompositeBar()
			...
			: this.acitivityBarPart.getPinnedPaneCompositeIds();
	}

	override getVisiblePaneCompositeIds(): string[] {
		return this.shouldShowCompositeBar()
			? super.getVisiblePaneCompositeIds()
			: this.acitivityBarPart.getVisiblePaneCompositeIds();
	}
				...
				class extends Action2 {
					constructor() {
						super({
							...
							title: {
								value: localize("accounts", "Accounts"),
								original: "Accounts",
							},
							menu: [
								{
