	...
	class extends Action2 {
		...
		constructor() {
			super({
				...
				title: {
					value: localize("focusPanel", "Focus into Panel"),
...
const PositionPanelActionConfigs: PanelActionConfig<Position>[] = [
	createPositionPanelActionConfig(
		...
		{
			value: localize("positionPanelLeft", "Move Panel Left"),
	...
	createPositionPanelActionConfig(
		...
		{
			value: localize("positionPanelRight", "Move Panel Right"),
	...
	createPositionPanelActionConfig(
		...
		{
			value: localize("positionPanelBottom", "Move Panel To Bottom"),
...
const AlignPanelActionConfigs: PanelActionConfig<PanelAlignment>[] = [
	createAlignmentPanelActionConfig(
		...
		{
			value: localize("alignPanelLeft", "Set Panel Alignment to Left"),
	...
	createAlignmentPanelActionConfig(
		...
		{
			value: localize("alignPanelRight", "Set Panel Alignment to Right"),
...
class SwitchPanelViewAction extends Action2 {
	...
	override async run(
		...
		const pinnedPanels = paneCompositeService.getPinnedPaneCompositeIds(
			ViewContainerLocation.Panel
		);
	...
	class extends Action2 {
		...
		run(accessor: ServicesAccessor) {
			...
			if (
				...
				layoutService.getPanelPosition() === Position.BOTTOM
			) {
	...
	class extends Action2 {
		constructor() {
			super({
				...
				title: {
					value: localize("closePanel", "Close Panel"),
		...
		constructor() {
			super({
				...
				title: {
					...
					original: "Close Secondary Side Bar",
				},
				category: Categories.View,
				icon: closeIcon,
				menu: [
	...
	},
	{
		...
		item: {
			...
			command: {
				id: TogglePanelAction.ID,
				title: {
					value: localize("hidePanel", "Hide Panel"),
					original: "Hide Panel",
				},
			},
