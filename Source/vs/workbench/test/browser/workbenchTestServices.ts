...
export function workbenchInstantiationService(
	...
	const accessibleNotificationService = disposables.add(
		new TestAccessibleNotificationService()
	);
	instantiationService.stub(
		IAccessibleNotificationService,
	...
	const editorService = overrides?.editorService
		...
		: new TestEditorService(editorGroupService);
...
export class TestServiceAccessor {
	constructor(
		...
		@IInstantiationService
		public instantitionService: IInstantiationService,
