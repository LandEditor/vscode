...
} from "vs/workbench/electron-sandbox/actions/developerActions";
import {
	ZoomResetAction,
	ZoomOutAction,
	ZoomInAction,
	...
	ExperimentalSplitWindowAction,
} from "vs/workbench/electron-sandbox/actions/windowActions";
...
} from "vs/workbench/electron-sandbox/actions/installActions";
import {
		...
		for (const command of [
			{
				...
				title: {
					value: localize("newTab", "New Window Tab"),
					original: "New Window Tab",
				},
			},
			{
			...
			},
			{
				...
				title: {
					value: localize("mergeAllWindowTabs", "Merge All Windows"),
					original: "Merge All Windows",
				},
			},
			{
