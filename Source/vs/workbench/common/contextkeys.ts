...
export const IsFullscreenContext = new RawContextKey<boolean>(
	"isFullscreen",
	false,
	localize("isFullscreen", "Whether the window is in fullscreen mode")
);
...
export const IsCenteredLayoutContext = new RawContextKey<boolean>(
	"isCenteredLayout",
	false,
	localize("isCenteredLayout", "Whether centered layout is enabled")
);
...
export const EditorAreaVisibleContext = new RawContextKey<boolean>(
	"editorAreaVisible",
	true,
	localize("editorAreaVisible", "Whether the editor area is visible")
);
...
export const EditorPinnedAndUnpinnedTabsContext = new RawContextKey<boolean>(
	"editorPinnedAndUnpinnedTabsVisible",
	false,
	true
);
export const MaximizedEditorGroupContext = new RawContextKey<boolean>(
	"maximizedEditorGroup",
	false,
	localize("editorGroupMaximized", "Editor group is maximized")
);
...
export function getEnabledViewContainerContextKey(
