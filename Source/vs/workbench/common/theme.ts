...
const OUTPUT_EDITOR_BACKGROUND = registerColor(
	"outputEditor.background",
	{
		dark: null,
		light: null,
		hcDark: null,
...
registerColor(
	"outputEditorStickyScroll.background",
	{
	...
	localize(
		"outputEditorStickyScrollBackground",
		"Output editor sticky scroll background color.",
	),
);
...
export const COMMAND_CENTER_INACTIVEBORDER = registerColor(
	...
	{
		dark: transparent(TITLE_BAR_INACTIVE_FOREGROUND, 0.25),
		hcDark: transparent(TITLE_BAR_INACTIVE_FOREGROUND, 0.25),
		light: transparent(TITLE_BAR_INACTIVE_FOREGROUND, 0.25),
		hcLight: transparent(TITLE_BAR_INACTIVE_FOREGROUND, 0.25),
	},
	localize(
		"commandCenter-inactiveBorder",
