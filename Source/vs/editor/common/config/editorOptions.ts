			...
			"editor.inlineSuggest.edits.experimental.onlyShowWhenCloseToCursor":
				{
					type: "boolean",
					default:
						defaults.edits.experimental.onlyShowWhenCloseToCursor,
					description: nls.localize(
						"inlineSuggest.edits.experimental.onlyShowWhenCloseToCursor",
		...
		return {
			...
			edits: {
				experimental: {
					...
					useMixedLinesDiff: stringSet(
						input.edits?.experimental?.useMixedLinesDiff,
					...
					useInterleavedLinesDiff: stringSet(
						input.edits?.experimental?.useInterleavedLinesDiff,
						this.defaultValue.edits.experimental
							.useInterleavedLinesDiff,
						["never", "always", "afterJump"],
					),
					onlyShowWhenCloseToCursor: boolean(
						input.edits?.experimental?.onlyShowWhenCloseToCursor,
						this.defaultValue.edits.experimental
							.onlyShowWhenCloseToCursor,
					),
				},
			},
		};
