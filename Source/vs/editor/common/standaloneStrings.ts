...
export namespace AccessibilityHelpNLS {
	...
	export const stickScrollKb = nls.localize(
		"stickScrollKb",
		"Focus Sticky Scroll ({0}) to focus the currently nested scopes.",
	);
	export const stickScrollNoKb = nls.localize(
		"stickScrollNoKb",
	...
	export const saveAudioCueDisabled = nls.localize(
		"saveAudioCueDisabled",
		"`audioCues.save` is disabled, so an alert will occur when a file is saved.",
	);
	export const saveAudioCueAlways = nls.localize(
		"saveAudioCueAlways",
		"`audioCues.save` is enabled, so will play whenever a file is saved.",
	);
	export const saveAudioCueUserGesture = nls.localize(
		"saveAudioCueUserGesture",
		"`audioCues.save` is enabled, so will play when a file is saved via user gesture.",
	);
	export const formatAudioCueDisabled = nls.localize(
		"formatAudioCueDisabled",
		"`audioCues.format` is disabled, so an alert will occur when a file is formatted.",
	);
	export const formatAudioCueAlways = nls.localize(
		"formatAudioCueAlways",
		"`audioCues.format` is enabled, so will play whenever a file is formatted.",
	);
	export const formatAudioCueUserGesture = nls.localize(
		"formatAudioCueUserGesture",
		"`audioCues.format` is enabled, so will play when a file is formatted via user gesture.",
	);
}
