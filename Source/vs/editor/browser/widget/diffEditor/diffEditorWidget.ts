...
export class DiffEditorWidget extends DelegatingEditor implements IDiffEditor {
	...
	constructor(
		...
		const unchangedRangesFeature = derivedDisposable(this, (reader) =>
			/** @description UnchangedRangesFeature */ this._instantiationService.createInstance(
		...
		derivedDisposable(this, (reader) =>
			/** @description DiffEditorDecorations */ this._instantiationService.createInstance(
		...
		const viewZoneManager = derivedDisposable(this, (reader) =>
			/** @description ViewZoneManager */ this._instantiationService.createInstance(
		...
		derivedDisposable(
			this,
			(reader) =>
				/** @description MovedBlocksLinesPart */ new (readHotReloadableExport(
