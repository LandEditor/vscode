...
import {
	TestLineToken,
	TestLineTokens,
} from "vs/editor/test/common/core/testLineToken";
...
suite("viewLineRenderer.renderLine 2", () => {
	...
	test("issue #116939: Important control characters aren't rendered", () => {
		const actual = renderViewLine(
			new RenderLineInput(
				false,
				false,
				`transferBalance(5678,${String.fromCharCode(
					0x202e
				)}6776,4321${String.fromCharCode(0x202c)},"USD");`,
				false,
				false,
				false,
				0,
	...
	test("getColumnOfLinePartOffset 1 - simple text", () => {
		const testGetColumnOfLinePartOffset =
			createTestGetColumnOfLinePartOffset(
				"hello world",
				4,
				[createPart(11, 1)],
				[11]
