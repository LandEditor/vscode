...
export class InlineCompletionsSource extends Disposable {
	...
	private readonly _structuredFetchLogger = this._register(
...
export function formatRecordableLogEntry<T extends IRecordableLogEntry>(
	...
	return (
		entry.sourceId +
		" @@ " +
		JSON.stringify({ ...entry, sourceId: undefined })
	);
}
...
> extends Disposable {
	...
	private readonly _contextKeyValue = observableContextKey<string>(
		this._contextKey,
	...
	public readonly isEnabled = this._contextKeyValue.map(
		(v) => v !== undefined,
	);
