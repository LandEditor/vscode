...
export class InlineCompletionsController extends Disposable {
	...
	private readonly _suggestWidgetAdapter = this._register(
	...
	protected readonly _view = this._register(
		new InlineCompletionsView(
			this.editor,
			this.model,
	...
	constructor(
		...
		this._register(
			contextKeySvcObs.bind(
				...
				this.model.map(
					(m, reader) =>
						m?.inlineEditState?.read(reader)?.cursorAtInlineEdit,
				),
			),
		);
		this._register(
