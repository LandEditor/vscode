	...
	implements IEditorContribution
{
	...
	private _onEditorMouseMove(mouseEvent: IEditorMouseEvent): void {
		const shouldReactToEditorMouseMove =
			this._shouldReactToEditorMouseMove(mouseEvent);
	...
	private _shouldReactToEditorMouseMove(
		...
		if (
			...
			(this._contentWidget.isFocused ||
				...
				(this._isMouseDown && this._contentWidget.isColorPickerVisible))
		) {
			return false;
		}
	...
	private _shouldRescheduleHoverComputation(): boolean {
		...
		const isContentHoverWidgetVisible =
			this._contentWidget?.isVisible ?? false;
