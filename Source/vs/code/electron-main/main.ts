...
} from "vs/platform/environment/electron-main/environmentMainService";
import {
	addArg,
...
import {
	IThemeMainService,
	ThemeMainService,
} from "vs/platform/theme/electron-main/themeMainService";
import {
...
import {
	ILoggerMainService,
	LoggerMainService,
} from "vs/platform/log/electron-main/loggerService";
import { LogService } from "vs/platform/log/common/logService";
import { massageMessageBoxOptions } from "vs/platform/dialogs/common/dialogs";
import {
	SaveStrategy,
	StateService,
} from "vs/platform/state/node/stateService";
...
class CodeMain {
	...
	private createServices(): [
		...
		services.set(
			IRequestService,
			new SyncDescriptor(RequestMainService, undefined, true),
		);
