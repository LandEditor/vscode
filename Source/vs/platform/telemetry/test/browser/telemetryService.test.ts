...
class ErrorTestingSettings {
	...
	public stack: string[];
	public randomUserFile: string =
		"a/path/that/doe_snt/con-tain/code/names.js";
...
suite("TelemetryService", () => {
	...
	test(
		...
		sinonTestFn(function (this: any) {
			const origErrorHandler =
				Errors.errorHandler.getUnexpectedErrorHandler();
	...
	test(
		...
		sinonTestFn(function (this: any) {
			...
			try {
				...
				const missingModelError: any = new Error(
	...
	test(
		...
		sinonTestFn(function (this: any) {
			...
			try {
				...
				const noSuchFileError: any = new Error(
